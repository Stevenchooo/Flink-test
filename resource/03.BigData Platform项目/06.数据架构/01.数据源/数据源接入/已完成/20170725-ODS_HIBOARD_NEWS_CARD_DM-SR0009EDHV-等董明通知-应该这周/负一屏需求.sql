...
PARTITIONED BY (                                                       
 ...
 LOCATION                                                               
   ...
   数据文件推送路径：/MFS/DataIn/OpenAlliance/odsdata/ODS_HIBOARD_SERVICE_CARD_DM   
...
XML配置文件：
           ...
           <FileToHDFS action="ODS_HIBOARD_SERVICE_CARD_DM">
            ...
            <MultiInputFileConf>
                <!-- 输入文件列表-->
                <InputFileList>/MFS/DataIn/OpenAlliance/odsdata/ODS_HIBOARD_SERVICE_CARD_DM/*ODS_HIBOARD_SERVICE_CARD_DM_*.txt.lzo</InputFileList>
...
PARTITIONED BY (                                                       
 ...
 LOCATION                                                               
   ...
   数据文件推送路径：/MFS/DataIn/OpenAlliance/odsdata/ODS_HIBOARD_NEWS_CARD_DM   
...
XML配置文件：
           ...
           <FileToHDFS action="ODS_HIBOARD_NEWS_CARD_DM">
            ...
            <MultiInputFileConf>
                <!-- 输入文件列表-->
                <InputFileList>/MFS/DataIn/OpenAlliance/odsdata/ODS_HIBOARD_NEWS_CARD_DM/*ODS_HIBOARD_NEWS_CARD_DM_*.txt.lzo</InputFileList>
                <!-- 输入文件个数  如果配置成-1，该参数无效，只考虑等待时间 -->
