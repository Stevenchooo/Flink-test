CREATE EXTERNAL TABLE ODS_KEYGUARD_DILI_CDN_DM (
...
PARTITIONED BY (                                                       
 ...
 LOCATION                                                               
   'hdfs://hacluster/AppData/BIProd/ODS/KEYGUARD/ODS_KEYGUARD_DILI_CDN_DM' 

数据文件推送路径：/MFS/DataIn/hadoop-NJ/odsdata/ODS_KEYGUARD_DILI_CDN_DM

XML配置文件：

           <FileToHDFS action="ODS_KEYGUARD_DILI_CDN_DM">
            <!-- 文件配置信息 -->
            <Fileconf>ODS_Hota</Fileconf>
            <!-- 输入文件配置-->
            <MultiInputFileConf>
                <!-- 输入文件列表-->
                <InputFileList>/MFS/DataIn/hadoop-NJ/odsdata/ODS_KEYGUARD_DILI_CDN_DM/*ODS_KEYGUARD_DILI_CDN_DM*.txt.gz</InputFileList>
            ...
            <!-- 表名 -->
            <Tablename>ODS_KEYGUARD_DILI_CDN_DM</Tablename>
            <!-- 表存储位置 -->
            <Tablelocation>KEYGUARD/ODS_KEYGUARD_DILI_CDN_DM</Tablelocation>
