CREATE EXTERNAL TABLE ODS_HIMOVIE_HVS_REL_PLAY_TV_DM(
epgid string comment 'EPG服务器ID',
userid string comment '用户编号',
areaid string comment '用户区域ID',
areaname string comment '用户区域名称',
...
starttimeutc string comment '话单开始时间UTC',
endtimeutc string comment '话单结束时间UTC',
...
deviceoriginal string comment 'VSP上报的原始的物理设备ID')
...
LOCATION 
   'hdfs://hacluster/AppData/BIProd/ODS/HIMOVIE/ODS_HIMOVIE_HVS_REL_PLAY_TV_DM'
数据文件推送路径：/MFS/DataIn/Communicate/odsdata/ODS_HIMOVIE_HVS_REL_PLAY_TV_DM
XML配置文件:
<FileToHDFS action="ODS_HIMOVIE_HVS_REL_PLAY_TV_DM">
<!-- 文件配置信息 -->
<Fileconf>ODS_Hota</Fileconf>
<!-- 输入文件配置-->
    <MultiInputFileConf>
        <!-- 输入文件列表-->
        <InputFileList>/MFS/DataIn/Communicate/odsdata/ODS_HIMOVIE_HVS_REL_PLAY_TV_DM/*_ODS_HIMOVIE_HVS_REL_PLAY_TV_DM_*.txt</InputFileList>
...
<!-- 表名 -->
<Tablename>ODS_HIMOVIE_HVS_REL_PLAY_TV_DM</Tablename>
<!-- 表存储位置 -->
<Tablelocation>HIMOVIE/ODS_HIMOVIE_HVS_REL_PLAY_TV_DM</Tablelocation>
