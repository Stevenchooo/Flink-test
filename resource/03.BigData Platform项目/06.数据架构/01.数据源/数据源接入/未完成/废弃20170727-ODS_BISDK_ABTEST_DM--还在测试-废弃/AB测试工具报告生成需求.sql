...
name string comment 'AB测试名称',
startTime string comment '实验开始时间',
endTime string comment '实验结束时间',
totalUserCount string comment '总参与用户数',
expectUserCount string comment '预期参数参与人数')
PARTITIONED BY (                                                       
   pt_d string)                                                       
 ROW FORMAT SERDE                                                       
 ...
 LOCATION                                                               
   ...
   数据文件推送路径：/MFS/DataIn/hadoop-NJ/odsdata/ODS_BISDK_ABTEST_DM   
...
id string comment '主键',
abTestId string comment 'AB测试ID',
name string comment '策略名称',
expectUserCount string comment '预期参数参与人数',
realUserCount string comment '预期参数参与人数')
PARTITIONED BY (                                                       
   pt_d string)                                                       
 ROW FORMAT SERDE                                                       
   'org.apache.hadoop.hive.ql.io.orc.OrcSerde'                          
 ...
 LOCATION                                                               
   ...
   数据文件推送路径：/MFS/DataIn/hadoop-NJ/odsdata/ODS_BISDK_STRATEGY_DM   
...
stgId string comment '策略ID',
imei string comment '用户imei')
PARTITIONED BY (                                                       
   pt_d string)                                                       
 ROW FORMAT SERDE                                                       
   'org.apache.hadoop.hive.ql.io.orc.OrcSerde'                          
 ...
 LOCATION                                                               
   ...
   数据文件推送路径：/MFS/DataIn/hadoop-NJ/odsdata/ODS_BISDK_USER_DM   
