# ----------------------------------------------------------------------------
#  File Name:   dw_core_up_user_info_dm.sql
...
#  Input：dim_user_info_ds,dw_core_all_user_oper_fact_dm,dim_core_channel2service_ds,dim_core_common_d_ds,ODS_UP_T_UP_MEMBERRIGHT_DM,dim_user_acct_info_ds
...
(
    ...
    biz_channel_id     STRING    COMMENT '操作渠道id',
