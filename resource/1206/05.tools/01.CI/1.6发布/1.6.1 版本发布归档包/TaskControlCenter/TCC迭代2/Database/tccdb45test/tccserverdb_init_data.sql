...
INSERT INTO `os_user_info` (user_name,pwd,`desc`) VALUES ('tcc45test','','tcc45test');
INSERT INTO `operator_info` (operator_name,pwd,`desc`,os_user_name,role_id,create_time) VALUES ('system','system','系统管理员','tcc45test','系统管理员',now());

INSERT INTO `node_info` VALUES ('10.120.5.45',1,'8',1024,500,'数据通道'),('10.120.5.45',2,'8',1024,500,'hadoop网关');
