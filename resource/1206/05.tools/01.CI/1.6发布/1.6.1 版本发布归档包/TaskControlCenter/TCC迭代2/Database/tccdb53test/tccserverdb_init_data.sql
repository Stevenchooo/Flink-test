...
INSERT INTO `os_user_info` (user_name,pwd,`desc`) VALUES ('tcc53test','','tcc53test');
INSERT INTO `operator_info` (operator_name,pwd,`desc`,os_user_name,role_id,create_time) VALUES ('system','system','系统管理员','tcc53test','系统管理员',now());
