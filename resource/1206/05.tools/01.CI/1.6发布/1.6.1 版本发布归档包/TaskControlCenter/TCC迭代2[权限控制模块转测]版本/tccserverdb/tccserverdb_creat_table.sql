...
CREATE TABLE `operate_audit_info` (
  ...
  `task_period` varchar(255) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=177984 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tcc_taskcontrolcenter_log` (
  ...
  KEY `cycleId` (`cycleId`),
  KEY `createTime` (`createTime`)
) ENGINE=InnoDB AUTO_INCREMENT=131010 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-07-02 21:57:26
