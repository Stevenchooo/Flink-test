		...
		var roots = {
			menu : [
				...
				{id : "1",name : "系统管理",	children : [
					{id : "1.0",name : "业务管理",url : "ServiceManage.jsp",target : "mainFrame",children : []},
					{id : "1.5",name : "节点管理",url : "NodeManage.jsp",target : "mainFrame",children : []},
					{id : "1.1",name : "权限管理",url : "#",	target : "mainFrame",children : [
						{id : "1.1.0",name : "OS组管理",url : "OSGroupManage.jsp",target : "mainFrame",children : []},
						{id : "1.1.1",name : "OS用户管理",url : "OSUserManage.jsp",target : "mainFrame",children : []},
						{id : "1.1.2",name : "角色管理",url : "RoleManage.jsp",target : "mainFrame",children : []}, 
						{id : "1.1.3",name : "用户管理",url : "UserManage.jsp",target : "mainFrame",children : []}
					]},
					{id : "1.2",name : "操作审计",url : "OperationRecord.jsp",target : "mainFrame",children : []},
					{id : "1.3",name : "日志查询",url : "LogDetailQuery.jsp",target : "mainFrame",children : []},
					{id : "1.4",name : "TCC配置",url : "loadTccConfig",target : "mainFrame",children : []}
				 ]} ,
