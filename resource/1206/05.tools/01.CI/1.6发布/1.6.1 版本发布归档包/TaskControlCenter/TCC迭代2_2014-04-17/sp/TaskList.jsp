			...
			<div region="center" border="false"
				...
				<form id="tccTaskForm" name="tccTaskForm" method="post">
					<table id="OptTaskTable" cellpadding="10px" cellspacing="5px"
						...
						<tr>
							<td><span>输出hive表: </span></td>
							<td><input id="hiveTableName" style="width: 250px" name="task.hiveTableName" />认真填写,质量检查
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><select id="endBatchFlag" editable="false"
								...
								panelHeight="auto" style="width: 200px" required="true">
									...
									<option value="1">指定的输入文件处理处理完成(个数严格)</option>
									<option value="2">等待时间内输入的文件处理完成(个数严格)</option>
						...
						<tr>
							<td><span>是否实时任务: </span></td>
							<td><input id="rtTaskFlag" type="radio"
								name="task.rtTaskFlag" value="true" />是
								<input id="rtTaskFlag" type="radio"
								name="task.rtTaskFlag" value="false" checked="checked" />否</td>
						</tr>
					</table>
				...
				<form id="dstTccServerAuthForm" method="post">
					<table id="DstTccServerAuthTable" cellpadding="15px"
						...
						<tr>
							...
							<td><input id="dstPassword" style="width: 150px" autocomplete="off" type="password"/> <font color="red">*</font>
							</td>
						</tr>
					</table>
				</form>
...
function clearTaskPage()
{
	...
	$("input[name= 'task.rtTaskFlag'][value='false']").attr('checked','checked');
...
function setData2TaskPage(rowData,grayFlag)
{
	...
	$("#hiveTableName").val(rowData["hiveTableName"]);
	...
	$("input[name= 'task.rtTaskFlag'][value='"+ rowData["rtTaskFlag"] +"']").attr('checked','checked');
