...
public class OdpDaoImpl extends SqlSessionDaoSupport implements OdpDao
{
     ...
     */
    @Override
    public void prepareGroupQuery(final GroupUserFilterParam param)
        throws CException
    {
        ...
        try
        {
            ...
            sb.append(')');
            param.setNeiDatas(sb.toString());
            getSqlSession().insert("com.huawei.devicecloud.platform.bi.odp.dao.userprofile.prepareGroupQuery", param);
        }
        catch (Exception e)
        {
