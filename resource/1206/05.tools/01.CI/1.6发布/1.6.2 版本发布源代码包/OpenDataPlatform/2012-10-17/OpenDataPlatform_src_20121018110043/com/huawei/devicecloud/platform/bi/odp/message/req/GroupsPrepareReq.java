...
public class GroupsPrepareReq extends GroupAuthenReq
{
    ...
    public void setCallback_url(final String callback_url)
    {
    ...
    public void setFilter_stmt(final String filter_stmt)
    {
    ...
    public void setBatch_info(final List<DateRatioInfo> batch_info)
    {
    ...
    public void setApp_transaction_id(final String appTId)
    {
        this.app_transaction_id = appTId;
    }
