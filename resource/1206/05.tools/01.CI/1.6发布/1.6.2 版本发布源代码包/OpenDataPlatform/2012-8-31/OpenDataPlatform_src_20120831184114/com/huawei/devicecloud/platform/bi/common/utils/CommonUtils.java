...
public final class CommonUtils
{
     ...
     * 
     * @param time 时间 如：2011-08-17T15:46:10+08:00
        ...
        throws CException
    {
        ...
        {
            timeFormat = "yyyy-MM-dd'T'HH:mm:ssZZ";
        }
        ...
        {
            LOGGER.error("convert time {} according to patter {} error", new Object[] {time, timeFormat}, e);
        ...
        throws CException
    {
        ...
        {
            //日期格式化
            date = DateFormatUtils.format(time, timeFormat);
        }
        catch (Exception e)
        {
            LOGGER.error("convert time {} according to patter {} error", new Object[] {time, timeFormat}, e);
