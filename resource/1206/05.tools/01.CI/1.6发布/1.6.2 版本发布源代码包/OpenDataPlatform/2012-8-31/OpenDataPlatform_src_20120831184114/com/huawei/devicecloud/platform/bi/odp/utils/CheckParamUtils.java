...
public final class CheckParamUtils
{
     ...
     * @throws CException 异常
     */
    public static void checkColumns(List<Integer> columns, String filedName)
        throws CException
    {
        ...
        throws CException
    {
        ...
        {
            if (null == dr || StringUtils.isBlank(dr.getDate()) || null == dr.getRatio() || dr.getRatio() < 0)
            {
                buildParameterInvalid(filedName, batchInfo);
                break;
            }
        ...
        throws CException
    {
        ...
        checkColumns(req.getExtractList(), "columns");
