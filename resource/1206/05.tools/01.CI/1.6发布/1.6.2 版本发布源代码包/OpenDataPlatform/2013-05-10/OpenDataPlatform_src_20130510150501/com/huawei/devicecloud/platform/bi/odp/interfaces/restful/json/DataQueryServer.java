...
public class DataQueryServer
{
    ...
    public ModelAndView fileUpLoadReq(@RequestHeader(value = "Authorization", required = false)String authenInfo, 
        HttpServletRequest req, HttpServletResponse rsp)
    {
        ...
        LOGGER.info("Exit upload_file successfully,request body is {}, return body is {}",
            new Object[] {uploadReq, uploadRsp});
