...
public final class CommonUtils
{
     ...
     * @see [类、类#方法、类#成员]
     */
    public static String getInterFaceAuthInfo(String info)
    {
        //鉴权信息= 大写(sha256(授权码+info))
        String authcode = CommonUtils.getSysConfig("authcode");
        
        String authInfo = null;
        try
        {
            authInfo = CryptUtil.encryptToSHA(authcode + info,null).toUpperCase();
        }
        catch (Exception e)
        {
            LOGGER.error("get authInfo error! info is {} and Exception is {}",new Object[] {info,e});
            return  null;
        }
