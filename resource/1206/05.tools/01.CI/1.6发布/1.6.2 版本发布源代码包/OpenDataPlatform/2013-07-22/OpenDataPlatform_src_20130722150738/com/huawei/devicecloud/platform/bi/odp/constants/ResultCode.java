...
public class ResultCode
{
    ...
    /**解压缩文件失败*/
    public static final int UNZIP_ERROR = 1015;
    
    /**文件不存在*/
    public static final int FILE_UN_EXIST = 1016;
    
    /**文件处理失败*/
    public static final int FILE_DEAL_ERROR = 1017;
    
    /**文件处理中*/
    public static final int FILE_DEAL_ING = 1018;
    
    /**文件上传接口调用失败*/
    public static final int FILE_UPLOAD_INTERFACE_ERROR = 1019;

    /**用户预留接口调用失败*/
    public static final int GROUPS_PREPARE_INTERFACE_ERROR = 1020;

    /**取消预留接口调用失败*/
    public static final int GROUPS_REVOKE_INTERFACE_ERROR = 1021;

    /**获取用户imei号文件失败*/
    public static final int GROUPS_FETCH_INTERFACE_ERROR = 1022;
}
