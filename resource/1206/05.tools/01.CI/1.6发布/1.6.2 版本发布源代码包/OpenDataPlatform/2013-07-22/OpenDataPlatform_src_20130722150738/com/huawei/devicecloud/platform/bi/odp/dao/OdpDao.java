...
public interface OdpDao
{
     ...
     * <新增预留信息（新实现方式）>
     * @param entity   预留信息列表
     * @throws CException  新增预留信息（新实现方式）异常
     * @see [类、类#方法、类#成员]
     */
    void addReservedNewInfo(ReservedNewInfoEntity entity) throws CException;

    /**
     * <查询是否包含预留信息>
     * @param groupId   预留ID
     * @return          预留信息
     * @throws CException   查询是否包含预留信息异常
     * @see [类、类#方法、类#成员]
     */
    ReservedNewInfoEntity getReservedNewInfo(String groupId)throws CException;

    /**
     * <删除预留信息>
     * @param groupId   预留ID
     * @throws CException   删除预留信息异常
     * @see [类、类#方法、类#成员]
     */
    void deleteNewReservedInfo(String groupId) throws CException;

    /**
     * <更新预留信息> 
     * @param entity   预留信息
     * @throws CException  更新预留信息异常
     * @see [类、类#方法、类#成员]
     */
    void updateReservedNewInfo(ReservedNewInfoEntity entity) throws CException;

    /**
     * <获取过期的预留信息列表> 
     * @return                 预留信息列表
     * @throws CException      获取过期的预留信息列表异常
     * @see [类、类#方法、类#成员]
     */
    List<ReservedNewInfoEntity> getExpiredReservedNewInfoList() throws CException;
}
