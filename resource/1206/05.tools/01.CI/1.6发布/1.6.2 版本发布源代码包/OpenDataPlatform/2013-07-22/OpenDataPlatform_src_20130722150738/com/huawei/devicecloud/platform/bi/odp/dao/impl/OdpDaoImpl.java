...
public class OdpDaoImpl extends SqlSessionDaoSupport implements OdpDao
{
    ...
    @Override
    public void addReservedNewInfo(ReservedNewInfoEntity entity)
        throws CException
    {
        LOGGER.debug("Enter addReservedNewInfo. entity is {}", entity);
        try
        {
            getSqlSession().insert("com.huawei.devicecloud.platform.bi.odp.dao.reservednew.addReservedNewInfo", entity);
        }
        catch (Exception e)
        {
            LOGGER.error("addReservedInfo failed! entity is {}", new Object[] {entity, e});
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    }

    @Override
    public ReservedNewInfoEntity getReservedNewInfo(String groupId)
        throws CException
    {
        LOGGER.debug("Enter getReservedNewInfo. groupId is {}", groupId);
        ReservedNewInfoEntity entity = null;
        try
        {
            entity =
                (ReservedNewInfoEntity)getSqlSession().selectOne("com.huawei.devicecloud.platform.bi.odp.dao."
                    + "reservednew.getReservedNewInfo",
                    groupId);
        }
        catch (Exception e)
        {
            LOGGER.error("getReservedNewInfo failed! groupId is {}", new Object[] {groupId, e});
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
        return entity;
    }
    ...
    @Override
    public void deleteNewReservedInfo(String groupId)
        throws CException
    {
        LOGGER.debug("Enter deleteNewReservedInfo. groupId is {}", groupId);
        try
        {
            getSqlSession().delete("com.huawei.devicecloud.platform.bi.odp.dao.reservednew.deleteNewReservedInfo",
                groupId);
        }
        catch (Exception e)
        {
            
            LOGGER.error("deleteNewReservedInfo failed! groupId is {}", new Object[] {groupId, e});
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    ...
    @Override
    public void updateReservedNewInfo(ReservedNewInfoEntity entity)
        throws CException
    {
        LOGGER.debug("Enter updateReservedNewInfo. ReservedNewInfoEntity is {}", entity);
        try
        {
            getSqlSession().update("com.huawei.devicecloud.platform.bi.odp.dao.reservednew.updateReservedNewInfo",
                entity);
        }
        catch (Exception e)
        {
            LOGGER.error("updateReservedNewInfo failed! entity is {}", new Object[] {entity, e});
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<ReservedNewInfoEntity> getExpiredReservedNewInfoList()
        throws CException
    {
        LOGGER.debug("Enter updateReservedNewInfo.");
        List<ReservedNewInfoEntity> list = null;
        try
        {
            list =
                getSqlSession().selectList("com.huawei.devicecloud.platform.bi.odp.dao.reservednew."
                    + "getExpiredReservedNewInfoList");
        }
        catch (Exception e)
        {
            LOGGER.error("getExpiredReservedNewInfoList failed! Exception is {}", new Object[] {e});
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
