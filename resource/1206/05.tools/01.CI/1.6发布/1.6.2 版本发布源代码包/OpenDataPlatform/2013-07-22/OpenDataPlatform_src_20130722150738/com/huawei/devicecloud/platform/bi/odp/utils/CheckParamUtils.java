...
public final class CheckParamUtils
{
        ...
        throws CException
    {
        ...
        //提取用户标识
        checkUserAdFlag(req.getUserAdFlag(),"user_ad_flag");
     ...
     * @see [类、类#方法、类#成员]
     */
    private static void checkUserAdFlag(Integer userAdFlag, String filedName)
        throws CException
    {
        if (null == userAdFlag || (!(UserAdFlagType.NORMAL == userAdFlag || UserAdFlagType.BLANK == userAdFlag)))
        {
            buildParameterInvalid(filedName, userAdFlag);
        }
    }
