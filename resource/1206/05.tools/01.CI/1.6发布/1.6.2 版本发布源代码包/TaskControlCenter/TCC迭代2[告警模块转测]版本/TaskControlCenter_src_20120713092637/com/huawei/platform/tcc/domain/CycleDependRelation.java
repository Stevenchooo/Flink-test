...
public class CycleDependRelation
{
     ...
     * true布尔类型的hashcode
     */
    private static final Integer TRUE_CODE = 1231;
    
    /**
     * false布尔类型的hashcode
     */
    private static final Integer FALSE_CODE = 1237;
    ...
    public int hashCode()
    {
        ...
        result = prime * result + (ignoreError ? TRUE_CODE : FALSE_CODE);
        return result;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (ignoreError != other.ignoreError)
        {
            return false;
        }
        return true;
