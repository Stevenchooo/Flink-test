...
public class AlarmFactInfoEntity
{
    ...
    {
        return "AlarmFactInfoEntity [alarmTime=" + alarmTime + ", cycleId="
                + cycleId + ", taskId=" + taskId + ", serviceId=" + serviceId
                + ", instanceId=" + instanceId + ", alarmGrade=" + alarmGrade
                + ", alarmType=" + alarmType + ", emailList=" + emailList
                + ", mobileList=" + mobileList + ", status=" + status
                + ", reason=" + reason + ", solution=" + solution
                + ", operatorName=" + operatorName + ", processTime="
                + processTime + "]";
    }
}