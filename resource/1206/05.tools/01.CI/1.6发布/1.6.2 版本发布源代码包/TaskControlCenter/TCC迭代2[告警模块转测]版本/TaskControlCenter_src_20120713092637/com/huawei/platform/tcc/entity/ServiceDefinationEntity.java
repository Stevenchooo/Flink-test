...
public class ServiceDefinationEntity
{
    ...
    private Integer maxReduceResource;
    ...
    public Integer getMaxReduceResource()
    {
        return maxReduceResource;
    }
    
    public void setMaxReduceResource(Integer maxReduceResource)
    {
        this.maxReduceResource = maxReduceResource;
    }
    ...
    public String toString()
    {
        ...
        builder.append(defaultPriority);
        builder.append(", maxReduceResource=");
        builder.append(maxReduceResource);
