...
public class ExceptionInterceptor extends AbstractInterceptor
{
    ...
    static
    {
        ...
        LOG_USER_ACTIONMAP.put("deleteIp", null);
        LOG_USER_ACTIONMAP.put("modifyLinuxUser", null);
        ...
        LOG_USER_ACTIONMAP.put("saveServiceDeploy", null);
        
        LOG_USER_ACTIONMAP.put("saveService", null);
        LOG_USER_ACTIONMAP.put("deleteService", null);
        
        LOG_USER_ACTIONMAP.put("saveServiceTG", null);
        LOG_USER_ACTIONMAP.put("deleteServiceTG", null);
