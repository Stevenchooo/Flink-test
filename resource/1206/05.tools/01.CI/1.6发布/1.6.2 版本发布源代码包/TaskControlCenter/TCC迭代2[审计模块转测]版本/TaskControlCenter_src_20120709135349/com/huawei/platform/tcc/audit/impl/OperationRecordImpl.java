...
public class OperationRecordImpl implements OperationRecord
{
     ...
     * @see [类、类#方法、类#成员]
     */
    public synchronized boolean writeOperLog(
            OperateAuditInfoEntity operateAuditInfo)
    {
        LOGGER.debug("Enter writeOperLog. operateAuditInfo is {}",
                operateAuditInfo);
        try
        {
        ...
        {
            LOGGER.error("writeOperLog failed! operateAuditInfo is {}",
                    operateAuditInfo,
                    e);
        }
        return false;
