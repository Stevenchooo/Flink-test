...
public interface TccDao extends Serializable
{
     ...
     *             统一封装的异常
     */
    public abstract List<TaskRunningStateEntity> getNeedAlarmTaskRSs(Long taskId, Date startTime,
        String maxCycleId)
        throws Exception;
    ...
    */
     ...
     * @throws Exception 异常
     */
    public abstract List<OperatorInfoEntity> getUsersByName(Search userSearch)
        throws Exception;
     ...
     * @throws Exception 统一封装的异常
     */
    public abstract Integer getUsersCountByName(Search search)
        throws Exception;
    ...
    */
     ...
     * @throws Exception 异常
     */
    public abstract Integer getUsersCount(OperatorInfoEntity operator)
        throws Exception;
