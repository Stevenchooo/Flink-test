...
public class TccDaoImpl extends SqlSessionDaoSupport implements TccDao
{
        ...
        throws CException
    {
        ...
        {
            Object stepRSO =
                getSqlSession().selectOne("com.huawei.platform.tcc.dao.steprunningstate.getStepRunningState", stepRS);
            if (null != stepRSO)
            {
        ...
        throws Exception
    {
        ...
        {
            Object objRtn =
                getSqlSession().selectList("com.huawei.platform.tcc.dao.operatorInfo.getUsersByName", userSearch);
        ...
        throws Exception
    {
        ...
        {
            Object objRtn =
                getSqlSession().selectOne("com.huawei.platform.tcc.dao.operatorInfo.getUsersCountByName", search);
        ...
        throws Exception
    {
        ...
        {
            Object objRtn =
                getSqlSession().selectOne("com.huawei.platform.tcc.dao.operatorInfo.getUsersCount", operator);
