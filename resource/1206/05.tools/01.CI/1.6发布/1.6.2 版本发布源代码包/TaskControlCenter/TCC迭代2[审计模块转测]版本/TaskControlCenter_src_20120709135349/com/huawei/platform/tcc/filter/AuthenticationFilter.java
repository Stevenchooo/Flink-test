...
public class AuthenticationFilter implements Filter
{
        ...
        throws IOException, ServletException
    {
        ...
        if (null == clientIp)
        {
            ...
            session.setAttribute(TccUtil.CLIENT_IP, mapIp.get(TccUtil.CLIENT_IP));
            session.setAttribute(TccUtil.IP_HEADER_NAME, mapIp.get(TccUtil.IP_HEADER_NAME));
            LOGGER.info("log clientIp[clientIp={},ipHeaderName={}] to session!",
                mapIp.get(TccUtil.CLIENT_IP),
                mapIp.get(TccUtil.IP_HEADER_NAME));
        }
