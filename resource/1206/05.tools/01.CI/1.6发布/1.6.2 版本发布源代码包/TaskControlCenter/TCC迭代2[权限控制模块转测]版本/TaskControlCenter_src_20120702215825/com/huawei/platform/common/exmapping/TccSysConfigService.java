/*
 * 文 件 名:  TccSysConfigService.java
 * 版    权:  Huawei Technologies Co., Ltd. Copyright 2009-2011,  All rights reserved
 * 描    述:  <描述>
 * 创 建 人:  q00107831
 * 创建时间:  2011-8-10
 */
package com.huawei.platform.common.exmapping;
 ...
 * 
 * @author  l00190934
 * @version [Internet Business Service Platform SP V100R100, 2011-12-7]
 * @see  [相关类/方法]
 */
public class TccSysConfigService
{
    /**
     * 存储资源文件中配置信息
     */
     ...
     * 资源文件路径
     */
    private static final String CONFIG_FILE_PATH = TccSysConfigService.class.getResource("/").getFile()
        + "../conf/common/resource/systemconfig/tcc.sysconfig.properties";
    
    private static final Logger LOGGER = LoggerFactory.getLogger(TccSysConfigService.class);
