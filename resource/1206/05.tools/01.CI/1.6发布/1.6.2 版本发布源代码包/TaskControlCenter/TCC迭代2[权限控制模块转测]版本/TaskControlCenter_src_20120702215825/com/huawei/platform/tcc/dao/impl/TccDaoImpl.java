...
public class TccDaoImpl extends SqlSessionDaoSupport implements TccDao
{
     ...
     * @see [类、类#方法、类#成员]
     */
    public void addTask(TaskEntity entity) throws Exception
    {
        LOGGER.debug("Enter addTask...");
        try
        {
            getSqlSession().insert("com.huawei.platform.tcc.dao.task.addTask",
                    entity);
        }
        catch (Exception e)
        {
     ...
     * @see [类、类#方法、类#成员]
     */
    public void updateTask(TaskEntity entity) throws Exception
    {
        LOGGER.debug("Enter updateTask...");
        try
        {
            getSqlSession().update("com.huawei.platform.tcc.dao.task.updateTask",
                    entity);
        }
        catch (Exception e)
        {
     ...
     */
    @Override
    public boolean startTask(TaskEntity entity) throws Exception
    {
        LOGGER.debug("Enter updateTask...");
        try
        {
            if (null == entity || null == entity.getTaskState()
                    || entity.getTaskState() != TaskState.NORMAL
                    || StringUtils.isEmpty(entity.getOsUserName())
                    || StringUtils.isEmpty(entity.getStartOperator()))
            {
                return false;
            }
            
            int objRtn = getSqlSession().update("com.huawei.platform.tcc.dao.task.startTask",
                    entity);
            if (objRtn == 1)
            {
                return true;
     ...
     */
    @Override
    public TaskEntity getTask(Long taskId) throws CException
    {
        LOGGER.debug("Enter getTask...");
        try
        {
            return (TaskEntity) getSqlSession().selectOne("com.huawei.platform.tcc.dao."
                    + "task.getTask",
                    taskId);
        }
        catch (Exception e)
     ...
     */
    @Override
    public TaskEntity getTask(String taskName) throws CException
    {
            ...
            throws CException
    {
        ...
        try
        {
            tasks = (List<TaskEntity>) getSqlSession().selectList("com.huawei.platform.tcc.dao."
                    + "task.getTaskList",
                    taskEnableFlag);
        }
        catch (Exception e)
            ...
            throws CException
    {
        ...
        try
        {
            taskList = (List<TaskEntity>) getSqlSession().selectList("com.huawei.platform.tcc.dao."
                    + "task.getTaskAllList",
                    entity);
        }
        catch (Exception e)
            ...
            throws CException
    {
        try
        {
            ...
            {
                Object obj = getSqlSession().selectList("com.huawei.platform.tcc.dao."
                        + "task.getTaskListByNames",
                        entity);
            ...
            throws CException
    {
        try
        {
            if (null != entity && !entity.getTaskNames().isEmpty())
            {
                Object objRtn = getSqlSession().selectOne("com.huawei.platform.tcc.dao."
                        + "task.getTaskListSizeByNames",
                        entity);
                if (null != objRtn)
                {
     ...
     */
    @Override
    public void deleteTask(Long taskId) throws CException
    {
        try
        {
            getSqlSession().delete("com.huawei.platform.tcc.dao."
                    + "task.deleteTask",
                    taskId);
        }
        catch (Exception e)
     ...
     */
    @Override
    public Integer getTaskListSize(TaskSearchEntity entity) throws CException
    {
            ...
            throws CException
    {
        ...
        try
        {
            if (!taskIds.isEmpty())
            {
                taskSteps = (List<TaskStepEntity>) getSqlSession().selectList("com.huawei.platform.tcc.dao."
    ...
    {
        LOGGER.debug("Enter getStepHost. taskId is [{}], stepId is [{}]",
                taskId,
                stepId);
        try
        {
            ...
            Object execCmdHost = getSqlSession().selectOne("com.huawei.platform.tcc.dao.taskstep.getStepHost",
                    taskSE);
        ...
        {
            LOGGER.error("get StepHost[taskId={},stepId={}] failed!",
                    new Object[] { taskId, stepId, e });
        }
     ...
     */
    @Override
    public String getMinCycleID(Long taskId) throws CException
    {
        LOGGER.debug("Enter getMinCycleID..., taskId is [{}]", taskId);
        try
        {
            Object minCycleId = getSqlSession().selectOne("com.huawei.platform.tcc.dao."
                    + "taskrunningstate.getMinCycleID",
                    taskId);
            if (null != minCycleId)
            {
     ...
     */
    @Override
    public String getMaxCycleID(Long taskId) throws CException
    {
        LOGGER.debug("Enter getMaxCycleID..., taskId is [{}]", taskId);
        try
        {
            Object maxCycleId = getSqlSession().selectOne("com.huawei.platform.tcc.dao."
                    + "taskrunningstate.getMaxCycleID",
                    taskId);
            if (null != maxCycleId)
            {
    ...
    public boolean isExistsTaskRS(Long taskId, String cycleId)
            throws CException
    {
        LOGGER.debug("Enter isExistsTaskRS. taskId is [{}], cycleId is [{}]",
                taskId,
                cycleId);
        try
        {
            ...
            Object count = getSqlSession().selectOne("com.huawei.platform.tcc.dao."
                    + "taskrunningstate.isExistsTaskRS",
                    taskRS);
            if (null != count)
            {
        ...
        {
            LOGGER.error("isExistsTaskRS execute failed taskId is [{}], cycleId is [{}]!",
     ...
     */
    @Override
    public boolean existsAllTaskIDCycleID(Integer equalCount,
            String taskIdCycleIds) throws CException
    {
        ...
        {
            Object count = getSqlSession().selectOne("com.huawei.platform.tcc.dao."
                    + "taskrunningstate.getCountTaskIDCycleID",
                    taskIdCycleIds);
            if (null != count)
            {
            ...
            throws CException
    {
        ...
        try
        {
            int rows = getSqlSession().insert("com.huawei.platform.tcc.dao.taskrunningstate.addTaskRunningState",
                    taskRS);
        ...
        {
            LOGGER.error("add TaskRunningState error, taskRS is [{}]!",
                    taskRS,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     *             统一封装的异常
     */
    public TaskRunningStateEntity getTaskRunningState(
            TaskRunningStateEntity taskRS) throws CException
    {
        ...
        {
            LOGGER.error("get TaskRunningState error, taskRS is [{}]!",
                    taskRS,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<TaskRunningStateEntity> getNeedRunCycleTasks(Long taskId,
            Date startTime, String maxCycleId) throws CException
    {
        ...
        try
        {
            ...
            if (null != startTime && startTime.after(TccConfig.getBenchDate()))
            {
                ...
                if (0 != cTime.get(Calendar.MINUTE)
                        || 0 != cTime.get(Calendar.SECOND))
                {
            ...
            taskRSLst = (List<TaskRunningStateEntity>) getSqlSession().selectList("com.huawei.platform.tcc.dao."
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<TaskRunningStateEntity> getTopOldNeedRunCycleTasks(Long taskId,
            Date startTime, String maxCycleId) throws CException
    {
        List<TaskRunningStateEntity> taskRSLst;
     ...
     */
    @Override
    public int getTaskRunningStateCount(
            List<TaskRunningStateEntity> taskIdCycleIDStateLst)
            throws CException
    {
        LOGGER.debug("Enter getTaskRunningStateCount. taskIdCycleIDStateLst is [{}]",
     ...
     */
    @Override
    public int getTaskRunningStateExceptStateCount(
            List<TaskRunningStateEntity> taskIdCycleIDStateLst)
            throws CException
    {
        LOGGER.debug("Enter getTaskRunningStateExceptStateCount. taskIdCycleIDStateLst is [{}]",
                taskIdCycleIDStateLst);
        try
        {
            if (!taskIdCycleIDStateLst.isEmpty())
        ...
        {
            LOGGER.error("getTaskRunningStateExceptStateCount excute failed, "
                    + "taskIdCycleIDStateLst is [{}]!",
                    taskIdCycleIDStateLst,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
            ...
            throws CException
    {
        ...
        {
            LOGGER.error("update TaskRunningState error, taskRS is [{}]!",
                    taskRS,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    public int updateTaskRunningStateWithNullTime(TaskRunningStateEntity taskRS)
            throws CException
    {
        LOGGER.debug("Enter updateTaskRunningStateWithNullTime..., taskRS is [{}]",
                taskRS);
        try
        {
            return getSqlSession().update("com.huawei.platform.tcc.dao.taskrunningstate"
        ...
        {
            LOGGER.error("update TaskRunningStateWithNullTime error, taskRS is [{}]!",
                    taskRS,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     */
    @Override
    public int updateAppendBeginDependTaskList(Long taskId, String cycleId,
            String appendTaskCycleId) throws CException
    {
        LOGGER.debug("Enter updateAppendBeginDependTaskList..., param is [taskId=[{}],cycleId=[{}]"
                + ",appendTaskCycleId=[{}]]",
                new Object[] { taskId, cycleId, appendTaskCycleId });
        try
        {
     ...
     */
    @Override
    public int updateAppendFinishDependTaskList(Long taskId, String cycleId,
            String appendTaskCycleId) throws CException
    {
        ...
        catch (Exception e)
        {
            LOGGER.debug("update AppendFinishDependTaskList failed, param is [taskId=[{}],cycleId=[{}],"
                    + "appendTaskCycleId=[{}]], error is [{}]",
                    new Object[] { taskId, cycleId, appendTaskCycleId, e });
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    }
    ...
    public boolean existsTimeOutBatchRS(Long taskId, String cycleId)
            throws CException
    {
        LOGGER.debug("Enter existsTimeOutBatchRS..., taskId is [{}], cycleId is [{}]",
                taskId,
                cycleId);
        try
        {
            ...
            Object count = getSqlSession().selectOne("com.huawei.platform.tcc.dao."
                    + "batchrunningstate.getCountTaskIDCycleID",
                    batchRS);
            if (null != count)
            {
                if ((Integer) count > 0)
        ...
        {
            LOGGER.error("existsTimeOutBatchRS excute failed, taskId is [{}], cycleId is [{}]!",
                    new Object[] { taskId, cycleId, e });
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     */
    @Override
    public boolean existsBatchRS(Long taskId, String cycleId) throws CException
    {
        LOGGER.debug("Enter existsTimeOutBatchRS..., taskId is [{}], cycleId is [{}]",
                taskId,
                cycleId);
        try
        {
            ...
            Object count = getSqlSession().selectOne("com.huawei.platform.tcc.dao."
                    + "batchrunningstate.getBatchRSCount",
                    batchRS);
            if (null != count)
            {
                if ((Integer) count > 0)
            ...
            throws CException
    {
        ...
        try
        {
            ...
            int rows = getSqlSession().insert("com.huawei.platform.tcc.dao.batchrunningstate.addBatchRunningState",
                    batchRS);
        ...
        {
            LOGGER.error("add BatchRunningState error, batchRS is [{}]!",
                    batchRS,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     *             统一封装的异常
     */
    public BatchRunningStateEntity getBatchRunningState(
            BatchRunningStateEntity batchRS) throws CException
    {
        ...
        {
            LOGGER.error("get BatchRunningState error, batchRS is [{}]!",
                    batchRS,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     */
    @Override
    public int getMaxBatchId(Long taskId, String cycleId) throws CException
    {
        LOGGER.debug("Enter getMaxBatchId..., taskId is [{}], cycleId is [{}]",
                taskId,
                cycleId);
        try
        {
            ...
            Object maxBatchId = getSqlSession().selectOne("com.huawei.platform.tcc.dao."
                    + "batchrunningstate.getMaxBatchId",
                    batchRS);
            if (null != maxBatchId)
            {
        ...
        {
            LOGGER.error("getMaxBatchId excute failed, taskId is [{}], cycleId is [{}]!",
                    new Object[] { taskId, cycleId, e });
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    public int deleteBatchRunningStates(Long taskId, String cycleId)
            throws CException
    {
        LOGGER.debug("Enter deleteBatchRunningStates..., taskId is [{}], cycleId is [{}]",
                taskId,
                cycleId);
        try
        {
        ...
        {
            LOGGER.error("deleteBatchRunningStates excute failed, taskId is [{}], cycleId is [{}]!",
                    new Object[] { taskId, cycleId, e });
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    }
    ...
    public int updateBatchRunningState(BatchRunningStateEntity batchRS)
            throws CException
    {
        LOGGER.debug("Enter updateBatchRunningState..., batchRS is [{}]",
                batchRS);
        try
        {
        ...
        {
            LOGGER.error("updateBatchRunningState excute failed, batchRS is [{}]!",
                    batchRS,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<BatchRunningStateEntity> getUnCompletedBatch(Long taskId,
            String cycleId) throws CException
    {
        List<BatchRunningStateEntity> batchRSLst;
        LOGGER.debug("Enter getUnCompletedBatch. taskId is [{}], cycleId is [{}]",
                taskId,
                cycleId);
        try
        {
            ...
            batchRSLst = (List<BatchRunningStateEntity>) getSqlSession().selectList("com.huawei.platform.tcc.dao."
                    + "batchrunningstate.getUnCompletedBatch",
                    batchRS);
        }
        catch (Exception e)
        {
            LOGGER.error("get UnCompletedBatch failed, taskId is [{}], cycleId is [{}]!",
                    new Object[] { taskId, cycleId, e });
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
            ...
            throws CException
    {
        ...
        LOGGER.debug("Enter getJobInputFiles. taskId is [{}], cycleId is [{}]",
                taskId,
                cycleId);
        try
        {
            ...
            batchFileLst = (List<String>) getSqlSession().selectList("com.huawei.platform.tcc.dao."
                    + "batchrunningstate.getJobInputFiles",
                    batchRS);
        }
        catch (Exception e)
        {
            LOGGER.error("get getJobInputFiles failed, taskId is [{}], cycleId is [{}]!",
                    new Object[] { taskId, cycleId, e });
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
        ...
        LOGGER.debug("get getJobInputFiles success. taskId is [{}], cycleId is [{}]",
                taskId,
                cycleId);
        return batchFileLst;
    }
    ...
    public int deleteStepRunningStates(Long taskId, String cycleId)
            throws CException
    {
        LOGGER.debug("Enter deleteStepRunningStates. taskId is [{}], cycleId is [{}]",
                taskId,
                cycleId);
        try
        {
        ...
        {
            LOGGER.error("deleteStepRunningStates excute failed, taskId is [{}], cycleId is [{}]!",
                    new Object[] { taskId, cycleId, e });
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<StepRunningStateEntity> getStartedStepRunningStates(
            Long taskId, String cycleId)
    {
        ...
        try
        {
            ...
            stepRSLst = (List<StepRunningStateEntity>) getSqlSession().selectList("com.huawei.platform.tcc.dao."
    ...
    public int getMaxStepId(Long taskId, String cycleId, int batchId)
            throws CException
    {
        LOGGER.debug("Enter getMaxStepId. param is [taskId=[{}], cycleId=[{}],batchId=[{}]]",
        ...
        try
        {
            ...
            Object maxStepId = getSqlSession().selectOne("com.huawei.platform.tcc.dao."
                    + "steprunningstate.getMaxStepId",
                    stepRS);
            if (null != maxStepId)
            {
            ...
            throws CException
    {
        ...
        try
        {
            int rows = getSqlSession().insert("com.huawei.platform.tcc.dao.steprunningstate.addStepRunningState",
                    stepRS);
        ...
        {
            LOGGER.error("add addStepRunningState error, stepRS is [{}]!",
                    stepRS,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
            ...
            throws CException
    {
        ...
        try
        {
            return getSqlSession().update("com.huawei.platform.tcc.dao."
                    + "steprunningstate.updateStepRunningState",
                    stepRS);
        }
        catch (Exception e)
        {
            LOGGER.error("updateStepRunningState excute failed, stepRS is [{}]!",
                    stepRS,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     */
    @Override
    public StepRunningStateEntity getStepRunningState(
            StepRunningStateEntity stepRS) throws CException
    {
        LOGGER.debug("Enter getStepRunningState..., stepRS is [{}]", stepRS);
        try
        {
            Object stepRSO = getSqlSession().selectOne("com.huawei.platform.tcc.dao.steprunningstate.getStepRunningState",
                    stepRS);
            if (null != stepRSO)
            {
        ...
        {
            LOGGER.error("getStepRunningState excute failed, stepRS is [{}]!",
                    stepRS,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    @Override
    public int deleteStepRunningStates(Long taskId, String cycleId,
            Integer batchId) throws CException
    {
        LOGGER.debug("Enter deleteStepRunningStates. param is [taskId=[{}], cycleId=[{}],batchId=[{}]]",
                new Object[] { taskId, cycleId, batchId });
        try
        {
            StepRunningStateEntity stepRS = new StepRunningStateEntity();
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<StepRunningStateEntity> getNoSucessedStepRunningStateLst(
            Long taskId, String cycleId, Integer batchId) throws CException
    {
        List<StepRunningStateEntity> stepRSLst = null;
            ...
            throws CException
    {
        ...
        try
        {
            getSqlSession().selectOne("com.huawei.platform.tcc.dao.taskidserial.genTaskSerialID",
                    entity);
        }
        catch (Exception e)
        {
     ...
     */
    @Override
    public int generateTaskStepID(Long taskId) throws CException
    {
        ...
        try
        {
            getSqlSession().selectOne("com.huawei.platform.tcc.dao.taskstep.genTaskStepSerialID",
                    entity);
        }
        catch (Exception e)
        {
     ...
     */
    @Override
    public void addTaskStep(TaskStepEntity entity) throws CException
    {
        LOGGER.debug("Enter addTaskStep. param is [entity={}]", entity);
        try
        {
            getSqlSession().update("com.huawei.platform.tcc.dao.taskstep.addTaskStep",
                    entity);
        }
        catch (Exception e)
        {
     ...
     */
    @Override
    public void updateTaskStep(TaskStepEntity entity) throws CException
    {
        LOGGER.debug("Enter updateTaskStep. param is [entity={}]", entity);
        try
        {
            getSqlSession().update("com.huawei.platform.tcc.dao.taskstep.updateTaskStep",
                    entity);
        }
        catch (Exception e)
        {
     ...
     */
    @Override
    public void deleteTaskStep(TaskStepEntity entity) throws CException
    {
        LOGGER.debug("Enter deleteTaskStep. param is [entity={}]", entity);
        try
        {
            getSqlSession().update("com.huawei.platform.tcc.dao.taskstep.deleteTaskStep",
                    entity);
        }
        catch (Exception e)
        {
     ...
     */
    @Override
    public TaskStepEntity getTaskStep(TaskStepEntity entity) throws CException
    {
        LOGGER.debug("Enter getTaskStep. param is [entity={}]", entity);
        try
        {
            Object obj = getSqlSession().selectOne("com.huawei.platform.tcc.dao.taskstep.getTaskStep",
                    entity);
     ...
     */
    @SuppressWarnings("unchecked")
    public List<TaskStepEntity> getTaskStepList(Long taskId) throws CException
    {
        ...
        try
        {
            ...
            Object obj = getSqlSession().selectList("com.huawei.platform.tcc.dao.taskstep.getTaskSteps",
                    taskId);
            ...
            throws CException
    {
        ...
        try
        {
            getSqlSession().update("com.huawei.platform.tcc.dao.taskstep.updateTaskStepId",
                    entity);
        }
        catch (Exception e)
        {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<Long> getAllTaskIdList(List<String> vSTgs) throws CException
    {
        ...
        try
        {
            ...
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.task.getAllTaskIdList",
                    nameMap);
            if (null != objRtn)
            {
            ...
            throws CException
    {
        ...
        try
        {
            ...
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.task.getAllTaskIdNameList",
                    sTgsSearch);
            if (null != objRtn)
            {
        ...
        {
            LOGGER.error("get getAllTaskIdNameList failed!  vSTgs is {}",
                    vSTgs,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    public int getVisualSuccessedTaskCycleNum(Long taskId, String cycleId)
            throws CException
    {
        LOGGER.debug("enter getVisualSuccessedTaskCycleNum, param is [taskId={}]",
                taskId);
        try
        {
            if (null == taskId)
        ...
        {
            LOGGER.error("get visual Successed taskCycleNum failed!,taskId=[{}]",
                    taskId,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     */
    @Override
    public String getMinVisualSuccessedCycleId(Long taskId) throws CException
    {
        LOGGER.debug("enter getMinVisualSuccessedCycleId, param is [taskId={}]",
                taskId);
        try
        {
            if (null == taskId)
            ...
            Object obj = getSqlSession().selectOne("com.huawei.platform.tcc.dao"
                    + ".taskrunningstate.getMinCycleIDByIDState",
                    taskRs);
            if (null == obj)
            {
                return null;
        ...
        {
            LOGGER.error("getMinVisualSuccessedCycleId failed!,taskId=[{}]",
                    taskId,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    public void updateTaskRunningStateIntegration(TaskCycleParam taskCycleParam)
            throws CException
    {
        LOGGER.debug("enter updateTaskRunningStateIntegration, param is [taskCycleParam={}]",
                taskCycleParam);
        try
        {
        ...
        {
            LOGGER.error("updateTaskRunningStateIntegration failed!,taskCycleParam=[{}]!",
                    taskCycleParam,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<BatchRunningStateEntity> getBatchRSList(Long taskId,
            String cycleId) throws CException
    {
        LOGGER.debug("enter getBatchRSList, param is [taskId={},cycleId={}]",
                taskId,
                cycleId);
        try
        {
            if (null != taskId && null != cycleId)
            {
                ...
                Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao"
                        + ".batchrunningstate.getBatchRSList",
                        batchRS);
        ...
        {
            LOGGER.error("getBatchRSList failed!,param=[taskId={},cycleId={}]!",
                    new Object[] { taskId, cycleId, e });
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<StepRunningStateEntity> getStepRSList(Long taskId,
            String cycleId) throws CException
    {
        LOGGER.debug("enter getStepRSList, param is [taskId={},cycleId={}]",
                taskId,
                cycleId);
        try
        {
            if (null != taskId && null != cycleId)
            {
                ...
                Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao"
                        + ".steprunningstate.getStepRSList",
                        stepRS);
        ...
        {
            LOGGER.error("getStepRSList failed!,param=[taskId={},cycleId={}]",
                    new Object[] { taskId, cycleId, e });
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<TaskRunningStateEntity> getTaskRSList(
            TaskRSQueryParam taskRSQueryParam) throws CException
    {
        LOGGER.debug("enter getTaskRSList, param is [taskRSQueryParam={}]",
                taskRSQueryParam);
        try
        {
        ...
        {
            LOGGER.error("getTaskRSList failed!, taskRSQueryParam={}",
                    taskRSQueryParam,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    public Integer getTaskRSCount(TaskRSQueryParam taskRSQueryParam)
            throws CException
    {
        LOGGER.debug("enter getTaskRSCount, param is [taskRSQueryParam={}]",
                taskRSQueryParam);
        try
        {
            if (null != taskRSQueryParam)
        ...
        {
            LOGGER.error("getTaskRSCount failed!, taskRSQueryParam={}",
                    taskRSQueryParam,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     */
    @Override
    public Integer getTaskRSCount(Long taskId) throws CException
    {
     ...
     * @see [类、类#方法、类#成员]
     */
    public int getTaskStepEnableSize(Long taskId) throws CException
    {
     ...
     */
    @Override
    public void deleteTaskSteps(Long taskId) throws CException
    {
     ...
     */
    @Override
    public void deleteTaskRunningStates(Long taskId) throws CException
    {
        LOGGER.debug("enter deleteTaskRunningStates, param is [taskId={}]",
                taskId);
        try
        {
            if (null != taskId)
            {
                getSqlSession().update("com.huawei.platform.tcc.dao.taskrunningstate.deleteTaskRunningStates",
                        taskId);
            }
        }
        catch (Exception e)
        {
            LOGGER.error("deleteTaskRunningStates failed!, taskId={}!",
                    taskId,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     */
    @Override
    public void deleteBatchRunningStates(Long taskId) throws CException
    {
        LOGGER.debug("enter deleteBatchRunningStates, param is [taskId={}]",
                taskId);
        try
        {
            if (null != taskId)
        ...
        {
            LOGGER.error("deleteBatchRunningStates failed!, taskId={}!",
                    taskId,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     */
    @Override
    public void deleteStepRunningStates(Long taskId) throws CException
    {
        LOGGER.debug("enter deleteStepRunningStates, param is [taskId={}]",
                taskId);
        try
        {
            if (null != taskId)
        ...
        {
            LOGGER.error("deleteStepRunningStates failed!, taskId={}!",
                    taskId,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     */
    @Override
    public void deleteDependTaskId(Long taskId) throws CException
    {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<TaskRunningStateEntity> getTaskRunningStateList(
            List<TaskRunningStateEntity> taskRSList) throws CException
    {
        LOGGER.debug("enter getTaskRunningStateList, param is [taskRSList={}]",
                taskRSList);
        try
        {
        ...
        {
            LOGGER.error("getTaskRunningStateList failed!, taskRSList={}!",
                    taskRSList,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     */
    @Override
    public void replaceDependTaskName2Id(TaskEntity task) throws CException
    {
        LOGGER.debug("enter replaceDependTaskName2Id, param is [task={}]", task);
        try
        {
            if (null != task && !StringUtils.isEmpty(task.getTaskName())
                    && null != task.getTaskId())
            {
                getSqlSession().update("com.huawei.platform.tcc.dao"
                        + ".task.replaceDependTaskName2Id",
                        task);
            }
        }
        catch (Exception e)
            ...
            throws CException
    {
        ...
        {
            LOGGER.error("get dependedTasks failed!, taskRSList={}!",
                    taskIds,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
            ...
            throws CException
    {
        ...
        try
        {
            if (null != taskRS && null != taskRS.getTaskId()
                    && !StringUtils.isEmpty(taskRS.getCycleId()))
            {
                Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao"
                        + ".log2DB.getTccLogList",
                        taskRS);
    ...
    public List<Log2DBEntity> getTccLogList(Log2DBQueryParam logQueryParam)
            throws CException
    {
        LOGGER.debug("enter getTccLogList, param is [logQueryParam={}]",
                logQueryParam);
        try
        {
        ...
        {
            LOGGER.debug("get tccLogList failed, param is [logQueryParam={}]",
                    logQueryParam,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    public Integer getTccLogCount(Log2DBQueryParam logQueryParam)
            throws CException
    {
        LOGGER.debug("enter getTccLogCount, param is [logQueryParam={}]",
                logQueryParam);
        try
        {
            if (null == logQueryParam)
        ...
        {
            LOGGER.debug("get tccLogCount failed, param is [logQueryParam={}]",
                    logQueryParam,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    public List<Log2DBEntity> getRsLogList(Log2DBQueryParam logQueryParam)
            throws CException
    {
        LOGGER.debug("enter getRsLogList, param is [logQueryParam={}]",
                logQueryParam);
        try
        {
            if (null == logQueryParam)
        ...
        {
            LOGGER.debug("getRsLogList failed, param is [logQueryParam={}]",
                    logQueryParam,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    public Integer getRsLogCount(Log2DBQueryParam logQueryParam)
            throws CException
    {
        LOGGER.debug("enter getRsLogCount, param is [logQueryParam={}]",
                logQueryParam);
        try
        {
            if (null == logQueryParam)
        ...
        {
            LOGGER.debug("getRsLogCount failed, param is [logQueryParam={}]",
                    logQueryParam,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<String> getAllUserName() throws CException
    {
        LOGGER.debug("enter getAllUserName.");
        try
        {
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao"
                    + ".log2DB.getAllUserName");
    ...
    public Integer getLongTimeShellsCount(LongTimeShellParam param)
            throws Exception
    {
        LOGGER.debug("enter getLongTimeShellsCount, param is [logQueryParam={}]",
                param);
        try
        {
            if (null == param)
            ...
            Object objRtn = getSqlSession().selectOne("com.huawei.platform.tcc.dao"
                    + ".steprunningstate.getLongTimeShellsCount",
                    param);
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<LongTimeShellEntity> getLongTimeShellList(
            LongTimeShellParam param) throws Exception
    {
        ...
        try
        {
            ...
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao"
                    + ".steprunningstate.getLongTimeShellList",
                    param);
     ...
     */
    @Override
    public void reInitTaskRS(TaskRSQueryParam queryParam) throws Exception
    {
    ...
    public void deleteRemoteshellLog(List<TaskIdCycleIdPair> taskIdCycleIds)
            throws CException
    {
        LOGGER.debug("enter deleteRemoteshellLog, taskIdCycleIds is {}",
                taskIdCycleIds);
        try
        {
            if (null != taskIdCycleIds && !taskIdCycleIds.isEmpty())
            {
                getSqlSession().delete("com.huawei.platform.tcc.dao.log2DB.deleteRemoteshellLog",
                        taskIdCycleIds);
            }
        }
        catch (Exception e)
        {
            LOGGER.error("deleteRemoteshellLog failed, taskIdCycleIds is [{}]",
                    taskIdCycleIds,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     * @see [类、类#方法、类#成员]
     */
    public List<TaskIdCycleIdPair> getNeedDeleteLogTaskRSs(
            ReserveCycleLogParam reserveCycleLog) throws Exception
    {
        LOGGER.debug("enter getNeedDeleteLogTaskRSs, param is [param={}]",
                reserveCycleLog);
        try
        {
            ...
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.log2DB.getNeedDeleteLogTaskRSs",
                    reserveCycleLog);
        ...
        {
            LOGGER.debug("get getNeedDeleteLogTaskRSs failed, param is {}",
                    reserveCycleLog,
                    e);
            throw e;
        }
            ...
            throws CException
    {
        ...
        try
        {
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.serviceDef.getAllServiceIdNameList");
     ...
     */
    @Override
    public List<ServiceDefinationEntity> getServicesByName(
            ServiceSearch serviceSearch) throws Exception
    {
        LOGGER.debug("Enter getServicesByNames. serviceSearch is {}",
                serviceSearch);
        try
        {
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.serviceDef.getServicesByName",
                    serviceSearch);
        ...
        {
            LOGGER.error("getServicesByNames failed! serviceSearch is {}",
                    serviceSearch,
                    e);
            throw e;
        }
    ...
    public Integer getServicesCountByName(ServiceSearch serviceSearch)
            throws Exception
    {
        LOGGER.debug("Enter getServicesCountByName. serviceSearch is {}",
                serviceSearch);
        try
        {
            Object objRtn = getSqlSession().selectOne("com.huawei.platform.tcc.dao.serviceDef.getServicesCountByName",
                    serviceSearch);
        ...
        {
            LOGGER.error("getServicesCountByName failed! serviceSearch is {}",
                    serviceSearch,
                    e);
            throw e;
        }
     ...
     */
    @Override
    public void addService(ServiceDefinationEntity serviceDef) throws Exception
    {
        LOGGER.debug("Enter addService. serviceDef is {}", serviceDef);
        try
        {
            getSqlSession().insert("com.huawei.platform.tcc.dao.serviceDef.addService",
                    serviceDef);
        }
        catch (Exception e)
        {
            ...
            throws Exception
    {
        ...
        try
        {
            getSqlSession().update("com.huawei.platform.tcc.dao.serviceDef.updateService",
                    serviceDef);
        }
        catch (Exception e)
        {
            LOGGER.error("updateService failed! serviceDef is {}",
                    serviceDef,
                    e);
            throw e;
        }
    ...
    public void deleteService(Integer serviceId) throws Exception
    {
        ...
        try
        {
            getSqlSession().delete("com.huawei.platform.tcc.dao.serviceDef.deleteService",
                    serviceId);
        }
        catch (Exception e)
        {
            ...
            throws Exception
    {
        ...
        try
        {
            getSqlSession().insert("com.huawei.platform.tcc.dao.serviceTG.addServiceTG",
                    serviceTG);
        }
        catch (Exception e)
        {
            ...
            throws Exception
    {
        ...
        try
        {
            getSqlSession().update("com.huawei.platform.tcc.dao.serviceTG.updateServiceTG",
                    serviceTG);
        }
        catch (Exception e)
        {
            LOGGER.error("updateTaskGroup failed! serviceTG is {}",
                    serviceTG,
                    e);
            throw e;
        }
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            if (null != serviceId)
            {
                objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.serviceTG.getAllServiceTGsByServiceId",
                        serviceId);
     ...
     * @throws Exception 统一封装的异常
     */
    public Integer getTaskGroupsCount(Search search) throws Exception
    {
        LOGGER.debug("Enter getTaskGroupsCount. search is {}", search);
        try
        {
            Object objRtn = getSqlSession().selectOne("com.huawei.platform.tcc.dao.serviceTG.getTaskGroupsCount",
                    search);
            ...
            throws Exception
    {
        ...
        try
        {
            getSqlSession().delete("com.huawei.platform.tcc.dao.serviceTG.deleteServiceTG",
                    taskGroup);
        }
        catch (Exception e)
        {
            LOGGER.error("deleteServiceTG failed! serviceId is {}",
                    taskGroup,
                    e);
            throw e;
        }
     ...
     */
    @Override
    public List<ServiceDeployInfoEntity> getServiceDeployInfo(
            ServiceDeployInfoEntity serviceDeploy) throws Exception
    {
        LOGGER.debug("enter getServiceDeployInfo, serviceDeploy is {}",
                serviceDeploy);
        try
        {
            ...
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.serviceDeploy.getServiceDeployInfo",
                    serviceDeploy);
        ...
        {
            LOGGER.error("getServiceDeployInfo failed, serviceDeploy is [{}].",
                    serviceDeploy,
                    e);
            throw e;
        }
    ...
    {
        LOGGER.debug("Enter addServiceDeploy. serviceDeploy is {}",
                serviceDeploy);
        try
        {
            int rows = getSqlSession().insert("com.huawei.platform.tcc.dao.serviceDeploy.addServiceDeploy",
                    serviceDeploy);
            if (rows > 0)
            {
                return true;
        ...
        {
            LOGGER.error("addServiceDeploy failed! serviceDeploy is {}",
                    serviceDeploy,
                    e);
        }
        return false;
    ...
    {
        LOGGER.debug("Enter updateServiceDeploy. serviceDeploy is {}",
                serviceDeploy);
        try
        {
            int rows = getSqlSession().update("com.huawei.platform.tcc.dao.serviceDeploy.updateServiceDeploy",
                    serviceDeploy);
            if (rows > 0)
            {
                return true;
        ...
        {
            LOGGER.error("updateServiceDeploy failed! serviceDeploy is {}",
                    serviceDeploy,
                    e);
        }
        return false;
    ...
    {
        LOGGER.debug("Enter deleteServiceDeploy. serviceDeploy is {}",
                serviceDeploy);
        try
        {
            int rows = getSqlSession().delete("com.huawei.platform.tcc.dao.serviceDeploy.deleteServiceDeploy",
                    serviceDeploy);
        ...
        {
            LOGGER.error("deleteServiceDeploy failed! serviceDeploy is {}",
                    serviceDeploy,
                    e);
        }
        return false;
     ...
     */
    @Override
    public OperatorInfoEntity getOperatorInfo(
            UsernameAndPasswordParam usernameAndPasswordParam)
            throws CException
    
    {
        LOGGER.debug("Enter getOperatorInfo. usernameAndPasswordParam is {}",
                usernameAndPasswordParam);
        try
        {
            Object objOperatorInfo = getSqlSession().selectOne("com.huawei.platform.tcc.dao"
    ...
    {
        LOGGER.debug("Enter getOperatorInfoByName. operatorName is {}",
                operatorName);
        try
        {
            Object objOperatorInfo = getSqlSession().selectOne("com.huawei.platform.tcc.dao"
                    + ".operatorInfo.getOperatorInfoByName",
                    operatorName);
            if (null != objOperatorInfo)
            {
                return (OperatorInfoEntity) objOperatorInfo;
        ...
        {
            LOGGER.error("getOperatorInfoByName failed! operatorName is {}",
                    operatorName,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
            ...
            throws CException
    {
        ...
        try
        {
            Object objOperatorInfo = getSqlSession().selectList("com.huawei.platform.tcc.dao"
                    + ".rolePrivilegeInfo.getRolePrivilegeInfo",
                    roleId);
            if (null != objOperatorInfo)
            {
            ...
            throws CException
    {
        ...
        try
        {
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.operatorInfo.getUsersByName",
                    userSearch);
        ...
        {
            LOGGER.error("getUsersByName failed! userSearch is {}",
                    userSearch,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     * @throws Exception 统一封装的异常
     */
    public Integer getUsersCountByName(Search search) throws Exception
    {
        LOGGER.debug("Enter getUsersCountByName. search is {}", search);
        try
        {
            Object objRtn = getSqlSession().selectOne("com.huawei.platform.tcc.dao.operatorInfo.getUsersCountByName",
                    search);
            ...
            throws CException
    {
        ...
        try
        {
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.operatorInfo.getUsersByRoleId",
                    roleId);
     ...
     * @throws Exception 统一封装的异常
     */
    public Integer getUsersCountByRoleId(String roleId) throws Exception
    {
        LOGGER.debug("Enter getUsersCountByRoleId. roleId is {}", roleId);
        try
        {
            Object objRtn = getSqlSession().selectOne("com.huawei.platform.tcc.dao.operatorInfo.getUsersCountByRoleId",
                    roleId);
        ...
        {
            LOGGER.error("getUsersCountByRoleId failed! roleId is {}",
                    roleId,
                    e);
            throw e;
        }
     ...
     * @throws CException 统一封装的异常
     */
    public void addUser(OperatorInfoEntity operatorInfo) throws CException
    {
        LOGGER.debug("Enter addUser. operatorInfo is {}", operatorInfo);
        try
        {
            getSqlSession().insert("com.huawei.platform.tcc.dao.operatorInfo.addUser",
                    operatorInfo);
        }
        catch (Exception e)
        {
     ...
     * @throws CException 统一封装的异常
     */
    public void updateUser(OperatorInfoEntity operatorInfo) throws CException
    {
        LOGGER.debug("Enter updateUser. operatorInfo is {}", operatorInfo);
        try
        {
            getSqlSession().update("com.huawei.platform.tcc.dao.operatorInfo.updateUser",
                    operatorInfo);
        }
        catch (Exception e)
        {
            LOGGER.error("updateUser failed! operatorInfo is {}",
                    operatorInfo,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     * @throws Exception 统一封装的异常
     */
    public void deleteUser(OperatorInfoEntity operatorInfo) throws Exception
    {
        LOGGER.debug("Enter deleteUser. operatorInfo is {}", operatorInfo);
        try
        {
            getSqlSession().delete("com.huawei.platform.tcc.dao.operatorInfo.deleteUser",
                    operatorInfo);
        }
        catch (Exception e)
        {
            LOGGER.error("deleteUser failed! operatorInfo is {}",
                    operatorInfo,
                    e);
            throw e;
        }
            ...
            throws Exception
    {
        ...
        try
        {
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.roleDef.getRolesByName",
                    roleSearch);
        ...
        {
            LOGGER.error("getRolesByName failed! roleSearch is {}",
                    roleSearch,
                    e);
            throw e;
        }
     ...
     * @throws Exception 异常
     */
    public Integer getRolesCountByName(Search search) throws Exception
    {
        LOGGER.debug("Enter getRolesCountByName. search is {}", search);
        try
        {
            Object objRtn = getSqlSession().selectOne("com.huawei.platform.tcc.dao.roleDef.getRolesCountByName",
                    search);
     ...
     * @throws CException 统一封装的异常
     */
    public RoleDefinationEntity getRole(String roleId) throws CException
    {
        LOGGER.debug("Enter getRole. roleId is {}", roleId);
        try
        {
            Object objRtn = getSqlSession().selectOne("com.huawei.platform.tcc.dao.roleDef.getRole",
                    roleId);
     ...
     */
    @Override
    public List<String> getAllRoleIdList() throws Exception
    {
            ...
            throws Exception
    {
        ...
        try
        {
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.serviceDef.getVisualServiceIdNames",
                    roleId);
        ...
        {
            LOGGER.error("getVisualServiceIdNames failed! roleId is {}",
                    roleId,
                    e);
            throw e;
        }
    ...
    public List<String> getVisualTaskGroupNames(String roleId, Integer serviceId)
            throws Exception
    {
        LOGGER.debug("Enter getVisualTaskGroupNames. roleId is {}, serviceId is {}",
                roleId,
                serviceId);
        try
        {
            ...
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.rolePrivilegeInfo.getVisualTaskGroupNames",
                    rolePri);
        ...
        {
            LOGGER.error("getVisualTaskGroupNames failed! roleId is {}, serviceId is {}",
                    new Object[] { roleId, serviceId, e });
            throw e;
        }
    }
            ...
            throws Exception
    {
        ...
        try
        {
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.rolePrivilegeInfo.getPrivileges",
                    search);
     ...
     * @throws Exception 异常
     */
    public void addRole(RoleDefinationEntity roleDef) throws Exception
    {
        LOGGER.debug("Enter addRole. roleDef is {}", roleDef);
        try
        {
            getSqlSession().insert("com.huawei.platform.tcc.dao.roleDef.addRole",
                    roleDef);
        }
        catch (Exception e)
        {
     ...
     * @throws Exception 异常
     */
    public void updateRole(RoleDefinationEntity roleDef) throws Exception
    {
        LOGGER.debug("Enter updateRole. roleDef is {}", roleDef);
        try
        {
            getSqlSession().update("com.huawei.platform.tcc.dao.roleDef.updateRole",
                    roleDef);
        }
        catch (Exception e)
        {
     ...
     * @throws Exception 异常
     */
    public void deleteRole(RoleDefinationEntity roleDef) throws Exception
    {
        LOGGER.debug("Enter deleteRole. roleDef is {}", roleDef);
        try
        {
            getSqlSession().delete("com.huawei.platform.tcc.dao.roleDef.deleteRole",
                    roleDef);
        }
        catch (Exception e)
        {
    ...
    public void addRolePrivilege(RolePrivilegeInfoEntity rolePrivilegeInfo)
            throws Exception
    {
        LOGGER.debug("Enter addRolePrivilege. rolePrivilegeInfo is {}",
                rolePrivilegeInfo);
        try
        {
            getSqlSession().insert("com.huawei.platform.tcc.dao.rolePrivilegeInfo.addRolePrivilege",
                    rolePrivilegeInfo);
        }
        catch (Exception e)
        {
            LOGGER.error("addRolePrivilege failed! rolePrivilegeInfo is {}",
                    rolePrivilegeInfo,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    public void updateRolePrivilege(RolePrivilegeInfoEntity rolePrivilegeInfo)
            throws Exception
    {
        LOGGER.debug("Enter updateRolePrivilege. rolePrivilegeInfo is {}",
                rolePrivilegeInfo);
        try
        {
        ...
        {
            LOGGER.error("updateRolePrivilege failed! rolePrivilegeInfo is {}",
                    rolePrivilegeInfo,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
    ...
    public void deleteRolePrivilege(RolePrivilegeInfoEntity rolePrivilegeInfo)
            throws Exception
    {
        LOGGER.debug("Enter deleteRolePrivilege. rolePrivilegeInfo is {}",
                rolePrivilegeInfo);
        try
        {
        ...
        {
            LOGGER.error("deleteRolePrivilege failed! rolePrivilegeInfo is {}",
                    rolePrivilegeInfo,
                    e);
            throw e;
        }
    ...
    public Integer getRolePrivilegeCount(
            RolePrivilegeInfoEntity rolePrivilegeInfo) throws Exception
    {
        LOGGER.debug("Enter getRolePrivilegeCount. rolePrivilegeInfo is {}",
                rolePrivilegeInfo);
        try
        {
            Object objRtn = getSqlSession().selectOne("com.huawei.platform.tcc.dao.rolePrivilegeInfo"
                    + ".getRolePrivilegeCount",
                    rolePrivilegeInfo);
        ...
        {
            LOGGER.error("getRolePrivilegeCount failed! rolePrivilegeInfo is {}",
                    rolePrivilegeInfo,
                    e);
            throw e;
        }
     ...
     * @throws Exception 异常
     */
    public List<OperatorInfoEntity> getUsersNoRoleId() throws Exception
    {
            ...
            throws Exception
    {
        ...
        try
        {
            Object objRtn = getSqlSession().selectList("com.huawei.platform.tcc.dao.OSUserInfo.getOSUsersByName",
                    search);
     ...
     * @throws Exception 异常
     */
    public Integer getOSUsersCountByName(Search search) throws Exception
    {
        LOGGER.debug("Enter getOSUsersCountByName. search is {}", search);
        try
        {
            Object objRtn = getSqlSession().selectOne("com.huawei.platform.tcc.dao.OSUserInfo.getOSUsersCountByName",
                    search);
        ...
        {
            LOGGER.error("getOSUsersCountByName failed! search is {}",
                    search,
                    e);
            throw e;
        }
     ...
     * @throws Exception 异常
     */
    public void addOSUser(OSUserInfoEntity mOSUserInfo) throws Exception
    {
        LOGGER.debug("Enter addOSUser. mOSUserInfo is {}", mOSUserInfo);
        try
        {
            getSqlSession().insert("com.huawei.platform.tcc.dao.OSUserInfo.addOSUser",
                    mOSUserInfo);
        }
        catch (Exception e)
        {
     ...
     * @throws Exception 异常
     */
    public void updateOSUser(OSUserInfoEntity mOSUserInfo) throws Exception
    {
        LOGGER.debug("Enter updateOSUser. mOSUserInfo is {}", mOSUserInfo);
        try
        {
            getSqlSession().update("com.huawei.platform.tcc.dao.OSUserInfo.updateOSUser",
                    mOSUserInfo);
        }
        catch (Exception e)
        {
            LOGGER.error("updateOSUser failed! mOSUserInfo is {}",
                    mOSUserInfo,
                    e);
            throw new CException(ResultCodeConstants.SYSTEM_ERROR, e);
        }
     ...
     * @throws Exception 异常
     */
    public void deleteOSUser(OSUserInfoEntity mOSUserInfo) throws Exception
    {
        LOGGER.debug("Enter deleteOSUser. mOSUserInfo is {}", mOSUserInfo);
        try
        {
            getSqlSession().delete("com.huawei.platform.tcc.dao.OSUserInfo.deleteOSUser",
                    mOSUserInfo);
        }
        catch (Exception e)
        {
            LOGGER.error("deleteOSUser failed! mOSUserInfo is {}",
                    mOSUserInfo,
                    e);
            throw e;
        }
    ...
    public OSUserInfoEntity getOSUser(String osUserName)
    {
        ...
        try
        {
            ...
            Object objRtn = getSqlSession().selectOne("com.huawei.platform.tcc.dao.OSUserInfo.getOSUser",
                    osUserName);
     ...
     * @throws Exception 异常
     */
    public Integer getUsersCount(OperatorInfoEntity operator) throws Exception
    {
        LOGGER.debug("Enter getUsersCount. operator is {}", operator);
        try
        {
            Object objRtn = getSqlSession().selectOne("com.huawei.platform.tcc.dao.operatorInfo.getUsersCount",
                    operator);
        ...
        throws Exception
    {
        ...
        try
        {
            getSqlSession().delete("com.huawei.platform.tcc.dao.operatorInfo.deleteInOperatorInfo",
                    operatorInfo);
        }
        catch (Exception e)
        {
            LOGGER.error("deleteInOperatorInfo failed! operatorInfo is {}",
                    operatorInfo,
                    e);
            throw e;
        }
