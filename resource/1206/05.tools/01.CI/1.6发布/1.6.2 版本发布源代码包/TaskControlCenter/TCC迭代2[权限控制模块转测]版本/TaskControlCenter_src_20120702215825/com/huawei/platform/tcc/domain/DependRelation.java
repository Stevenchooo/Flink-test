...
public class DependRelation
{
     ...
     * 是否同周期依赖
     */
    public static final int SAMPLECYCLEDEPEND_INDEX = 3;
    ...
    private boolean sameCycleDepend;
     ...
     * @param bSameCycleDepend 是否同周期依赖
     */
    public DependRelation(Long dependTaskId, boolean bFullCycleDepend, boolean bIgnoreError, Boolean bSameCycleDepend)
    {
        this.dependTaskId = dependTaskId;
        this.fullCycleDepend = bFullCycleDepend;
        this.ignoreError = bIgnoreError;
        this.sameCycleDepend = (null == bSameCycleDepend) ? false : bSameCycleDepend;
    }
    ...
    public boolean isSameCycleDepend()
    {
        return sameCycleDepend;
    }

    public void setSameCycleDepend(boolean sameCycleDepend)
    {
        this.sameCycleDepend = sameCycleDepend;
    }
}
