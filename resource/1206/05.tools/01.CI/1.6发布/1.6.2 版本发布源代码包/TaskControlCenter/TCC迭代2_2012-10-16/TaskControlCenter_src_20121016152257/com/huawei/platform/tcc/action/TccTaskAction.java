...
public class TccTaskAction extends BaseAction
{
        ...
        throws Exception
    {
        ...
        if (null == mOperator || !mOperator.canModify(srcServiceId, srcGroupName))
        {
            priParams.add(new PrivilegeNotEnoughParam(getServiceName(srcServiceId), srcGroupName,
        ...
        {
            checkModifyServiceTGPri(mOperator, priParams, dstServiceId, dstGroupName, srcServiceId, srcGroupName);
        }
     ...
     * 检查是否具有修改任务组权限
     */
    private void checkModifyServiceTGPri(Operator operator, List<PrivilegeNotEnoughParam> priParams,
        Integer dstServiceId, String dstGroupName, Integer srcServiceId, String srcGroupName)
    {
        ...
        throws Exception
    {
        ...
        if (null != request.getParameter("taskIds"))
        {
            ...
            for (String taskIdStr : taskIdStrArr)
            {
                if (!StringUtils.isEmpty(taskIdStr))
                {
                    ...
                    {
                        LOGGER.warn("grabTaskName error! taskIdStr is {}.", taskIdStr, e);
                    }
                }
            }
        }
        ...
        {
            LOGGER.error("grab grabTaskIdNames fail! taskIds is {}", request.getParameter("taskIds"), e);
        }
