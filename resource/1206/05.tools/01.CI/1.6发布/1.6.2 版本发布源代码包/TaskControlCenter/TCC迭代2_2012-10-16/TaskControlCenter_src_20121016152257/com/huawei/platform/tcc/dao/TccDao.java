...
public interface TccDao extends Serializable
{
    ...
    */
     ...
     * @throws Exception 异常
     */
    public abstract List<OperatorInfoEntity> getUsers(UserSearch userSearch)
        throws Exception;
    ...
    */
     ...
     * @throws Exception 异常
     */
    public abstract List<RolePrivilegeInfo> getHavePrivileges(Search search)
        throws Exception;
    ...
    */
     ...
     * @see [类、类#方法、类#成员]
     */
    public abstract void changeTaskEnableFlag(TaskEntity entity)
        throws Exception;
}
