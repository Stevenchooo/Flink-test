 ...
 * 
 * @author  z00190465
 * @version [Internet Business Service Platform SP V100R100,, 2012-2-27]
 */
public class AlarmConfig
{
    ...
    {
        return "AlarmConfig [alarmType=" + alarmType + ", taskId=" + taskId
                + ", isAlarmPermitted=" + isAlarmPermitted
                + ", normalEmailList=" + normalEmailList
                + ", normalMobileList=" + normalMobileList
                + ", severeEmailList=" + severeEmailList
                + ", severeMobileList=" + severeMobileList
                + ", latestStartTime=" + latestStartTime + ", latestEndTime="
                + latestEndTime + ", maxRunTime=" + maxRunTime + "]";
    }
}
