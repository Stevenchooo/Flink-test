...
public class TaskStepEntity
{
    ...
    public String getExecCmdHost()
    {
        return execCmdHost;
    }
    
    public void setExecCmdHost(String execCmdHost)
    {
        this.execCmdHost = execCmdHost == null ? null : execCmdHost.trim();
    }
