...
public class OSGroupManageAction extends BaseAction
{
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            //返回空数据
            Integer count = tccDao.getOSGroupsCountBySearch(search);
            //否则以名字模糊查询
            List<OSGroupInfoEntity> groups = tccDao.getOSGroupsBySearch(search);
        ...
        throws Exception
    {
        ...
        //获取所有的用户组
        List<OSGroupInfoEntity> groupList = getTccDao().getOSGroups();
    ...
    public synchronized String saveOSGroup()
    {
        ...
        try
        {
            ...
            {
                //新增记录
                tccDao.addOSGroup(osGroup);
                //记录操作日志
                LOGGER.info("add osGroup[{}] successfully!", new Object[] {TccUtil.truncatEncode(osGroup)});
            ...
            {
                //更新记录
                tccDao.updateOSGroup(osGroup);
                
                //记录日志
                LOGGER.info("update osGroup[{}] successfully!", new Object[] {TccUtil.truncatEncode(osGroup)});
        ...
        catch (Exception e)
        {
            ...
            LOGGER.error("failed to " + opt + " the osGroup[{}].", new Object[] {TccUtil.truncatEncode(osGroup), e});
        }
        ...
        throws Exception
    {
        ...
        try
        {
            if (null != userGroup)
            {
                ...
                //删除OS组
                tccDao.deleteOSGroup(groupE);
                
                //记录日志
                LOGGER.info("delete group[{}] success.", TccUtil.truncatEncode(userGroup));
                rv.setSuccess(true);
        ...
        catch (Exception e)
        {
            ...
            LOGGER.info("deleteOSGroup error! userGroup is {}.", TccUtil.truncatEncode(userGroup), e);
        }
        ...
        {
            LOGGER.error("failed to delete osGroup[{}].", TccUtil.truncatEncode(userGroup), e);
            throw e;
        }
