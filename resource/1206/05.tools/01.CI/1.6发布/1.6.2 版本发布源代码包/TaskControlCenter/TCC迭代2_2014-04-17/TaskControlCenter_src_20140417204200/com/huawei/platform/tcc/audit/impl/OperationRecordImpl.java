...
public class OperationRecordImpl implements OperationRecord
{
    ...
    public boolean writeOperLog(OperateAuditInfoEntity operateAuditInfo)
    {
        ...
        {
            LOGGER.error("writeOperLog failed! operateAuditInfo is {}", TccUtil.truncatEncode(operateAuditInfo), e);
        }
        return false;
    }
        ...
        throws Exception
    {
        ...
        {
            LOGGER.error("readRecord failed, search is [{}].", TccUtil.truncatEncode(search), e);
            throw e;
        }
    }
        ...
        throws Exception
    {
        ...
        {
            LOGGER.error("getRecordCount failed! search is {}", TccUtil.truncatEncode(search), e);
            throw e;
        }
    }
