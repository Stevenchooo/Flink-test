 ...
 * 
 * @author  l00194471
 * @version [Device Cloud Base Platform Dept TaskControlCenter V100R100, 2012-7-2]
 */
public class OperType
{
     ...
     * 告警处理
     */
    public static final int ALARM_HANDLE = 151;
    
    /**
     * 告警配置
     */
    public static final int ALARM_CONFIGURE = 152;
     ...
     * 删除三个月前的所有审计记录
     */
    public static final int OPERATIONRECORD_DELOLD = 316;
    
    /**
     * 新增OS用户组
     */
    public static final int OS_GROUP_ADD = 411;
    
    /**
     * 更新OS用户组
     */
    public static final int OS_GROUP_UPDATE = 412;
    
    /**
     * 删除OS用户组
     */
    public static final int OS_GROUP_DELETE = 413;
    
    /**
     * 新增节点
     */
    public static final int NODE_ADD = 511;
    
    /**
     * 更新节点
     */
    public static final int NODE_UPDATE = 512;
    
    /**
     * 删除节点
     */
    public static final int NODE_DELETE = 513;
    
    /**
     * 同步到测试
     */
    public static final int SYNC_TEST = 601;
    
    /**
     * 同步到生产
     */
    public static final int SYNC_PRODUCE = 602;
}
