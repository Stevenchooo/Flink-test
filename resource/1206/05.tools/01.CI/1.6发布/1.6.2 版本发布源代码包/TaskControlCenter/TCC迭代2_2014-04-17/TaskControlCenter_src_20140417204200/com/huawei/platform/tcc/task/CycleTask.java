...
public class CycleTask implements Runnable, Comparable<CycleTask>
{
        ...
        throws CException
    {
        ...
        {
            strict =
                task.getEndBatchFlag() == EndBatchFlag.FILES || task.getEndBatchFlag() == EndBatchFlag.FILESINWAITTING
                    || task.getEndBatchFlag() == EndBatchFlag.NORWAITTING_STRICT;
        }
        
        if (strict && inputedFiles.size() < task.getInputFileMinCount())
        {
