 ...
 * 
 * @author  z00190465
 * @version [Device Cloud Base Platform Dept TaskControlCenter V100R100, 2012-4-27]
 */
public class AuthenticationFilter implements Filter
{
     ...
     * 登陆页面
     */
    private static final String LOGIN = "/TaskControlCenter/login.jsp";
    
    /**
     * 等待页面
     */
    private static final String WAIGGING = "/TaskControlCenter/waitting.jsp";
    
    /**
     * 普通操作员主页
     */
    private static final String OPERATOR_INDEX = "/TaskControlCenter/index.jsp";
    
    /**
     * 系统管理员主页
     */
    private static final String SYSTEM_INDEX = "/TaskControlCenter/SysAdminIndex.jsp";
    
    /**
     * 加载任务接口
     */
    private static final String LOAD_TASKS = "/TaskControlCenter/loadTasks";
    
    /**
     * 准备加载任务接口
     */
    private static final String PREPARE_LOAD_TASKS = "/TaskControlCenter/prepareLoadTasks";
        ...
        throws IOException, ServletException
    {
        ...
        //不拦截
        if (uri.endsWith(LOAD_TASKS) || uri.endsWith(PREPARE_LOAD_TASKS))
        {
