 ...
 */
public class TccPortalServiceImpl implements TccPortalService
{
        ...
        throws CException
    {
        ...
        try
        {
            Integer taskIDSerailNo;
            if (TccConfig.isTaskIdCenter())
            {
                taskIDSerailNo = tccDao.generateTaskIDSerialNo(serviceID, taskType);
            }
            else
            {
                List<DBServerConfigEntity> dbServerConfigs = tccDao.getDBServers();
                if (null == dbServerConfigs || dbServerConfigs.isEmpty())
                {
                    LOGGER.error("dbServerConfig don't exist!");
                    return null;
                }
                
                //使用第一个dbserver配置
                TccDao dstDao = daoFactory.createDao(dbServerConfigs.get(0));
                taskIDSerailNo = dstDao.generateTaskIDSerialNo(serviceID, taskType);
            }
        ...
        catch (Exception e)
        {
            LOGGER.error("generateTaskID failed, serviceID is [{}],taskType is [{}].", new Object[] {serviceID,
                taskType, e});
            throw new CException(ResultCode.GENERATE_TASKID_ERROR, new Object[] {serviceID, taskType});
        }
        return taskID;
    }
    ...
    public List<Long> getTaskIdsByNames(TaskSearchEntity entity)
        throws CException
    {
        return tccDao.getTaskIdsByNames(entity);
    }
        ...
        throws Exception
    {
        ...
        try
        {
            taskList = tccDao.getTaskListByServiceTG(entity);
        }
        catch (Exception e)
        {
        ...
        throws CException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    LOGGER.error("dbServerConfig don't exist!");
                    throw new Exception("dbServerConfig don't exist!");
                }
                
                //使用第一个dbserver配置
                TccDao dstDao = daoFactory.createDao(dbServerConfigs.get(0));
                return dstDao.generateTaskStepID(taskId);
            }
    ...
    */
        ...
        throws CException
    {
        ...
        try
        {
            return tccDao.getAllTaskIdNameList(vGroups);
        }
        catch (Exception e)
        {
        ...
        throws CException
    {
        ...
        catch (Exception e)
        {
            LOGGER.error("getBatchRSList failed!,param=[taskId={},cycleId={}]!",
                new Object[] {taskId, TccUtil.truncatEncode(cycleId), e});
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    }
        ...
        throws CException
    {
        ...
        try
        {
            return tccDao.getBatchRSList(taskId, cycleId, startIndex, rows);
        }
        catch (Exception e)
        {
            LOGGER.error("getBatchRSList failed!,param=[taskId={},cycleId={}]!",
        ...
        throws CException
    {
        ...
        try
        {
            return tccDao.getBatchRSCount(taskId, cycleId);
        }
        catch (Exception e)
        {
            LOGGER.error("getBatchRSCount failed!,param=[taskId={},cycleId={}]!",
                new Object[] {taskId, TccUtil.truncatEncode(cycleId), e});
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    }
        ...
        throws CException
    {
        ...
        try
        {
            return tccDao.getStepRSList(taskId, cycleId, startIndex, rows);
        }
        catch (Exception e)
        {
            LOGGER.error("getStepRSList failed!,param=[taskId={},cycleId={},startIndex={},rows={}]", new Object[] {
                taskId, TccUtil.truncatEncode(cycleId), startIndex, rows, e});
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    }
        ...
        throws CException
    {
        ...
        try
        {
            return tccDao.getStepRSCount(taskId, cycleId);
        }
        catch (Exception e)
        {
            LOGGER.error("getStepRSCount failed!,param=[taskId={},cycleId={}]",
                new Object[] {taskId, TccUtil.truncatEncode(cycleId), e});
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    }
        ...
        throws CException
    {
        ...
        {
            LOGGER.error("getTaskRSList failed!, taskRSQueryParam={}!", TccUtil.truncatEncode(taskRSQueryParam), e);
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
        ...
        throws CException
    {
        ...
        {
            LOGGER.error("getTaskRSCount failed!, taskRSQueryParam={}", TccUtil.truncatEncode(taskRSQueryParam), e);
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    }
        ...
        throws CException
    {
        ...
        {
            LOGGER.error("deleteDependTaskId failed!, taskRSList={}!", TccUtil.truncatEncode(taskRSList), e);
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    }
        ...
        throws Exception
    {
        ...
        try
        {
            //保证获取的告警渠道包含所有告警等级的渠道列表
            List<TaskAlarmChannelInfoEntity> alarmChannelExist = tccDao.getAlarmChannelList(taskId);
            List<TaskAlarmChannelInfoEntity> alarmChannelList = new ArrayList<TaskAlarmChannelInfoEntity>();
            TaskAlarmChannelInfoEntity alarmChannelNormal = null;
            TaskAlarmChannelInfoEntity alarmChannelSevere = null;
            for (TaskAlarmChannelInfoEntity alarmChannel : alarmChannelExist)
            {
                if (null == alarmChannelNormal && alarmChannel.getAlarmGrade().equals(GradeType.NORMAL))
                {
                    alarmChannelNormal = alarmChannel;
                }
                
                if (null == alarmChannelSevere && alarmChannel.getAlarmGrade().equals(GradeType.SEVERE))
                {
                    alarmChannelSevere = alarmChannel;
                }
            }
            
            if (null == alarmChannelNormal)
            {
                alarmChannelNormal = new TaskAlarmChannelInfoEntity();
                alarmChannelNormal.setTaskId(taskId);
                alarmChannelNormal.setAlarmGrade(GradeType.NORMAL);
            }
            
            if (null == alarmChannelSevere)
            {
                alarmChannelSevere = new TaskAlarmChannelInfoEntity();
                alarmChannelNormal.setTaskId(taskId);
                alarmChannelSevere.setAlarmGrade(GradeType.SEVERE);
            }
            
            alarmChannelList.add(alarmChannelNormal);
            alarmChannelList.add(alarmChannelSevere);
            return alarmChannelList;
        }
        catch (Exception e)
        {
     ...
     */
    @Override
    public TaskAlarmChannelInfoEntity getAlarmChannel(Long taskId, Integer grade)
        throws Exception
    {
        LOGGER.debug("Enter getAlarmChannelList. taskId is {}", taskId);
        try
        {
            if (null == taskId || null == grade)
            {
                return null;
            }
            
            TaskAlarmChannelInfoEntity alarmChannel = new TaskAlarmChannelInfoEntity();
            alarmChannel.setTaskId(taskId);
            alarmChannel.setAlarmGrade(grade);
            return tccDao.getAlarmChannel(alarmChannel);
        }
        catch (Exception e)
        {
            LOGGER.error("getAlarmChannelList failed! taskId is {}", taskId, e);
        ...
        throws Exception
    {
        ...
        try
        {
            return tccDao.getTaskAlarmItems(taskId);
        }
        catch (Exception e)
        {
        ...
        throws Exception
    {
        ...
        try
        {
            return tccDao.getAlarmThreshold(taskId);
        }
        catch (Exception e)
        {
        ...
        throws Exception
    {
        ...
        try
        {
            tccDao.addAlarmChannel(alarmChannel);
        }
        catch (Exception e)
        {
            LOGGER.error("addAlarmChannel failed! alarmChannel is {}", TccUtil.truncatEncode(alarmChannel), e);
            throw e;
        }
    }
        ...
        throws Exception
    {
        ...
        try
        {
            tccDao.updateAlarmChannel(alarmChannel);
        }
        catch (Exception e)
        {
            LOGGER.error("updateAlarmChannel failed! alarmChannel is {}", TccUtil.truncatEncode(alarmChannel), e);
            throw e;
        }
    }
        ...
        throws Exception
    {
        ...
        try
        {
            tccDao.deleteAlarmChannel(taskId);
        }
        catch (Exception e)
        {
    ...
    /**
     * 新增告警阈值
     * @param alarmThre 告警阈值
     * @throws Exception 异常
     */
    @Override
    public void addAlarmThreshold(TaskAlarmThresholdEntity alarmThre)
        throws Exception
    {
        LOGGER.debug("Enter addAlarmChannel. alarmThreshold is {}", alarmThre);
        try
        {
            tccDao.addAlarmThreshold(alarmThre);
        }
        catch (Exception e)
        {
            LOGGER.error("addAlarmThreshold failed! alarmThreshold is {}", TccUtil.truncatEncode(alarmThre), e);
            throw e;
        }
    }
     ...
     */
    @Override
    public void updateAlarmThreshold(TaskAlarmThresholdEntity alarmThre)
        throws Exception
    {
        LOGGER.debug("Enter updateAlarmThreshold. alarmThreshold is {}", alarmThre);
        try
        {
            tccDao.updateAlarmThreshold(alarmThre);
        }
        catch (Exception e)
        {
            LOGGER.error("updateAlarmThreshold failed! alarmThreshold is {}", TccUtil.truncatEncode(alarmThre), e);
            throw e;
        }
    }
        ...
        throws Exception
    {
        ...
        try
        {
            tccDao.deleteAlarmThreshold(taskId);
        }
        catch (Exception e)
        {
        ...
        throws Exception
    {
        ...
        try
        {
            tccDao.addAlarmItems(alarmItems);
        }
        catch (Exception e)
        {
            LOGGER.error("addAlarmItems failed! alarmItems is {}", TccUtil.truncatEncode(alarmItems), e);
            throw e;
        }
    }
        ...
        throws Exception
    {
        ...
        try
        {
            tccDao.updateAlarmItems(alarmItems);
        }
        catch (Exception e)
        {
            LOGGER.error("updateAlarmItems failed! alarmItems is {}", TccUtil.truncatEncode(alarmItems), e);
            throw e;
        }
    }
        ...
        throws Exception
    {
        ...
        try
        {
            tccDao.deleteAlarmItems(taskId);
        }
        catch (Exception e)
        {
        ...
        throws Exception
    {
        ...
        try
        {
            tccDao.updateAlarmFact(alarmFact);
        }
        catch (Exception e)
        {
            LOGGER.error("updateAlarmFact failed! alarmFact is {}", TccUtil.truncatEncode(alarmFact), e);
            throw e;
        }
    }
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            return tccDao.getAlarmFacts(search);
        }
        catch (Exception e)
        {
            LOGGER.error("getAlarmFacts failed! search is {}", TccUtil.truncatEncode(search), e);
            throw e;
        }
    }
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            return tccDao.getAlarmFactCount(search);
        }
        catch (Exception e)
        {
            LOGGER.error("getAlarmFactCount failed! search is {}", TccUtil.truncatEncode(search), e);
            throw e;
        }
    }
    ...
    public List<TaskOwnerInfo> getTaskOwnersByIds(List<Long> taskIdList)
    {
        ...
        try
        {
            return tccDao.getTaskOwnersByIds(taskIdList);
        }
        catch (Exception e)
        {
