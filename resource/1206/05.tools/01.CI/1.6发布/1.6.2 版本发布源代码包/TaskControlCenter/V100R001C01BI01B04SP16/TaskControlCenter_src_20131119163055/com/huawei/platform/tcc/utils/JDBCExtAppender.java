 ...
 * JDBCAppender扩展类
 * @author  z00190465
 * @version [Device Cloud Base Platform Dept TaskControlCenter V100R100, 2012-1-11]
 */
public class JDBCExtAppender extends JDBCAppender
{
    ...
    {
        org.apache.log4j.Logger rs2DbLog = LogManager.getLogger("cmd_execute_info");
    ...
    public synchronized void flushBuffer()
    {
        try
        {
            ...
            for (Iterator<LoggingEvent> i = buffer.iterator(); i.hasNext();)
            {
                ...
                msg = (null == msg) ? "" : msg.replace("\\", "\\\\").replace("\"", "\"\"");
