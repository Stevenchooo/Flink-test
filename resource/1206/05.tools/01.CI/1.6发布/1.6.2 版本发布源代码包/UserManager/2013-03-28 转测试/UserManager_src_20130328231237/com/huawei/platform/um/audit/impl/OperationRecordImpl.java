 ...
 * 创建时间:  2012-7-2
 */
package com.huawei.platform.um.audit.impl;
...
public class OperationRecordImpl implements OperationRecord
{
    ...
    public boolean writeOperLog(OperateAuditInfoEntity operateAuditInfo)
    {
        ...
        try
        {
            ...
            umDao.addOperLog(operateAuditInfo);
            return true;
        }
        catch (Exception e)
        {
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            return umDao.getOperationRecords(search);
        }
        catch (Exception e)
        {
        ...
        throws Exception
    {
        ...
        try
        {
            if (null != search)
            {
                return umDao.getRecordCount(search);
            }
            else
            {
                return 0;
        ...
        throws Exception
    {
        ...
        try
        {
            umDao.deleteOldOperationRecord(date);
        }
        catch (Exception e)
        {
