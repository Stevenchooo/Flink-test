 ...
 * 
 * @author  z00190465
 * @version [Device Cloud Base Platform Dept UserManager V100R100, 2012-4-18]
 */
public class ConfigAction extends BaseAction
{
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            UserProfileEntity userProfile = parseRequest(request);
            getUmDao().addOrUpdateUserProfile(userProfile);
    ...
    private UserProfileEntity parseRequest(HttpServletRequest request)
    {
        String values = request.getParameter("profile");
        UserProfileEntity profile = UMUtil.parseObject(values, UserProfileEntity.class);
    ...
    public String getProfile()
    {
        ...
        try
        {
            ...
            result = UMUtil.buildReturnObj("profile",profile);
        }
        catch (Exception e)
        {
            LOGGER.error("saveProfile failed!", e);
     ...
     * 将命令控制台输出日志中
     * @author  z00190465
     * @version [Device Cloud Base Platform Dept UserManager V100R100, 2012-4-28]
     */
