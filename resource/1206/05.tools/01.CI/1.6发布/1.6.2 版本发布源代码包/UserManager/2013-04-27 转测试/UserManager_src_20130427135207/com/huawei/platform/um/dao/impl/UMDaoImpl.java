...
public class UMDaoImpl extends SqlSessionDaoSupport implements UMDao
{
    ...
    * @throws Exception 异常
        ...
        throws CException
    {
        ...
        {
            LOGGER.error("getUserInfo failed! userInfo is {}.", userInfo, e);
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    }
        ...
        throws CException
    {
        ...
        {
            final Object objRtn =
                getSqlSession().selectOne("com.huawei.platform.um.dao.userinfo.getUserProfile", userName);
            ...
            {
                return (UserProfileEntity)objRtn;
            }
        }
        catch (Exception e)
        {
            LOGGER.error("getUserProfile failed! user is {}.", userName, e);
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    }
     ...
     * @throws CException 异常
     */
    public boolean addOrUpdateUserProfile(UserProfileEntity profile)
        throws CException
    {
        try
        {
            final int rows =
                getSqlSession().update("com.huawei.platform.um.dao.userinfo.addOrUpdateUserProfile", profile);
            
            return rows > 0;
        }
        catch (Exception e)
        {
            LOGGER.error("getUserProfiles failed! user is {}.", profile, e);
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    }
     ...
     */
    @Override
    public boolean addOrUpdateUserInfo(UserInfoEntity userInfo)
        throws CException
    {
        try
        {
            final int rows =
                getSqlSession().insert("com.huawei.platform.um.dao.userinfo.addOrUpdateUserInfo", userInfo);
            
            return rows > 0;
        }
        catch (Exception e)
        {
            LOGGER.error("getUserProfiles failed! user is {}.", userInfo, e);
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    }
     ...
     * @throws CException 异常
     */
    public ReportConfigEntity getReportCfg(Integer nodeId)
        throws CException
    {
        try
        {
            final Object objRtn =
                getSqlSession().selectOne("com.huawei.platform.um.dao.reportcfg.getReportCfg", nodeId);
            ...
            {
                return (ReportConfigEntity)objRtn;
            }
        }
        catch (Exception e)
        {
            LOGGER.error("getReportCfg failed! nodeId is {}.", nodeId, e);
            throw new CException(ResultCode.SYSTEM_ERROR, e);
        }
    }
    ...
    {
        LOGGER.debug("Enter deleteUserInfo. userName is {}", userName);
        try
        {
            int rows = getSqlSession().delete("com.huawei.platform.um.dao.userinfo.deleteUserInfo", userName);
        ...
        {
            LOGGER.error("deleteUserInfo failed! userName is {}", userName, e);
        }
        return false;
    }
    ...
    {
        LOGGER.debug("Enter deleteUserProfile. userName is {}", userName);
        try
        {
            int rows = getSqlSession().delete("com.huawei.platform.um.dao.userinfo.deleteUserProfile", userName);
        ...
        {
            LOGGER.error("deleteUserProfile failed! userName is {}", userName, e);
        }
        return false;
    }
    /************************* portal [end] ***********************************************/
