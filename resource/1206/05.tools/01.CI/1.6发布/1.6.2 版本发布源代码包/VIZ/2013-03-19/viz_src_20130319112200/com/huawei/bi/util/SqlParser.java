...
public class SqlParser
{
    ...
    private void parseTables()
    {
        ...
        else if(isContains(sql, "\\s+limit\\s+"))
        {
            regex = "(from)(.+)(limit)";
        }
        else
    ...
    public static void main(String[] args)
    {
        List<String> ls = new ArrayList<String>();
                ls.add("select * from dual limit 10");    
        ...
        //        ls.add("Select c1,c2,c3 From t1,t2,t3 Where condi1=5 and condi6=6 or condi7=7 Group  by g1,g2");
//        ls.add("Select c1 as CC,c2,c3 From t1,t2,t3 Where condi1=5 and condi6=6 or condi7=7 Group  by g1,g2,g3 order  by g2,g3");
        
        for (String sql : ls)
        {
            System.out.println(new SqlParser(sql).tables);
