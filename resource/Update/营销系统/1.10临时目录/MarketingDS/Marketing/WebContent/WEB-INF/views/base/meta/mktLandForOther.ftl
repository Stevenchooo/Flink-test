    ...
    <div class="up-detable">
      <table >
        <tr> 
             ...
             <th width="15%">${lang.mktLandInfoLandUrl}</th>
             <th width="5%">${lang.mktLandInfoStatus}</th>
             <th width="5%">${lang.mktLandInfoOperat}
             </th>
        </tr>
...
<div id="id_modify_mktLandInfo_other_dialog" style="display:none;font-size: 12px;">
 ...
 <div id="other_landInfo_batchLoad_dialog" style="display:none;">
...
<div id="other_land_batchPublish_dialog" style="display:none;">
...
<div id="id_mktLandOtherEmail_dialog" style="display:none;font-size: 12px;">
  <form name="mktLandHonnrInfoEmailForm" class="css-form" novalidate autocomplete="off">
     <table class="listTab" style="width:600px;">
        ...
        <tr ng-repeat="row in mktLandHonnrEmailUsers">
        
             <td> 
                <input type="checkbox"  id="emailLandHonnrUsers" name="emailLandHonnrUsers" value="{{row.account}}" />&nbsp;&nbsp;
             </td>
             <td>{{row.account}}</td>
             <td>{{row.name}}</td>
...
seajs.use(["modules/base/model", "modules/base/meta/mktLandForOther"], function(model, MetaMktLandForOther) {
    var meta =  MetaMktLandForOther.instance("${vars.webRoot}", 'mktLandForOther', ["mktinfoId","name"]);
    model.showList({
        id:"${id}",
        meta:meta,
