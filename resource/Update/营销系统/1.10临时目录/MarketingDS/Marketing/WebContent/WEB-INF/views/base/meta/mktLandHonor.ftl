...
<div id="id_modify_mktLandInfo_honor_dialog" style="display:none;font-size: 12px;">
 ...
 <div id="honor_landInfo_batchLoad_dialog" style="display:none;">
...
<div id="honor_land_batchPublish_dialog" style="display:none;">
...
<div id="id_mktLandHonnrEmail_dialog" style="display:none;font-size: 12px;">
...
seajs.use(["modules/base/model", "modules/base/meta/mktLandHonor"], function(model, MetaMktLandHonor) {
    var meta =  MetaMktLandHonor.instance("${vars.webRoot}", 'mktLandHonor', ["mktinfoId","name"]);
    model.showList({
        id:"${id}",
        meta:meta,
