          ...
          <table border="0">
           <tr>
            ...
            <td class="input_content">
              <input type="text" id="loginAccount" name="account" class="input_text"  onkeyup="loginAccountCheck()"/>
           ...
           <tr>
            ...
            <td class="input_content">
              <input type="password" id="loginPwd" name="pwd" class="input_text"  onkeyup="loginPwdCheck()"/>
           ...
           <tr>
            ...
            <td class="input_content">
              <div style="display: inline;" id="verifyCodeDiv">
                <input type="text" name="verifyCode" id="verifyCode" class="input_text" style="width: 50px; vertical-align: top;" />
