...
/* Controllers */
  ...
  app.controller('MainController2', ['$scope', '$state', function($scope, $state) {    
	  $scope.options = [
        { label: '华为商城-pc端', value: '1' },
	    { label: '华为荣耀官网-移动端', value: '6' },
	    { label: '华为荣耀新官网', value: '7' },
	    { label: '荣耀7产品预约页面-wap端', value: '8' },
	    { label: '荣耀邀请函微信推广渠道', value: '9' }
	  ];
	  
	  $scope.tt = $scope.options[0];
	  
	  $scope.locationChangeFunction = function(){
		  $state.go("app.website_summary", {sid: $scope.tt});
	  }
