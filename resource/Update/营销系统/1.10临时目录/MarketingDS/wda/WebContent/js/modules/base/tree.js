...
function(require, exports, module) {
	...
	exports.showUrl = function(meta, url) {
		var nodes = mTree.getSelectedNodes();  
		showListPage(nodes[0].id, meta, url)
	};
	...
	exports.show = function(opts) {
        ...
        if(mMetas == null) {
        	mMetas = {};
	        // 获得元模型
	        $.ajax({type:"POST", url: __webRoot+"/api/meta/query", async:false, 
