...
public class AdminResetPwd extends AuthRDBProcessor
{
            ...
            CallableStatement statement) throws SQLException
    {
        ...
        String newPwd = SecureUtil.generatePassword(account,
        ...
        context.setParameter(PWD, newPwd); // save it into request parameters,
                                            // use it when response
