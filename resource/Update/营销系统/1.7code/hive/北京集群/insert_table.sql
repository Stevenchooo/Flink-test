...
insert into  dim_mkt_base_info_ds(activtiy_id,activity_name,media_id,media_name,sid,begin_date,end_date,
                                  ...
                                  productName,cid,operator,state,channel,ad_position,material_type,dept_type,aid,delivery_times,port,platform)
select * from 
(
    select tt.id                        as activtiy_id,        
           ...
           t1.material_type             as material_type,
           t1.dept_type                 as dept_type,
           t1.aid                       as aid,
           t1.delivery_times            as delivery_times,
           t1.port                      as port,
