mysql -h 10.41.24.199 -umktsystem -pRdmdlDVEQj76RLgffLNv mktsystemdb < /MFS/Share/hadoop-NJ/task/HiBI/HIBI/config/insert_table.sql

mysql -h 10.41.24.199 -umktsystem -pRdmdlDVEQj76RLgffLNv mktsystemdb  -N -e "select activtiy_id,activity_name,media_id,media_name,sid,begin_date,end_date,estimate_exp,estimate_click,media_type,url_host,landing_plate,resourceName,productName,cid,operator,state,channel,ad_position from dim_mkt_base_info_ds " >/MFS/Share/hadoop-NJ/task/HiBI/HIBI/config/mkt/dim_mkt_base_info_ds.txt
