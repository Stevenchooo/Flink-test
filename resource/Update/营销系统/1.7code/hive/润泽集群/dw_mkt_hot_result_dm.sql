# ----------------------------------------------------------------------------
#  File Name:dw_mkt_hot_result_dm.sql
...
use biwarehouse;
CREATE EXTERNAL TABLE IF NOT EXISTS dw_mkt_hot_result_dm(
     activtiy_id STRING,
     cid STRING,
     url STRING,
     entercount STRING,
...
LOCATION '/AppData/EUIProd/TCSM/data/DW/TCSM/dw_mkt_hot_result_dm';

INSERT OVERWRITE TABLE dw_mkt_hot_result_dm
PARTITION (pt_d = '$date')
        ...
        (
          ...
          join 
           ...
           from ods_vmall_hi_data_dm
                where action_type=1 and pt_d='$date' and idsite in ('www.vmall.com','mm.vmall.com','sale.vmall.com','m.vmall.com','mt.vmall.com','msale.vmall.com','mw.vmall.com','ma.vmall.com','asale.vmall.com')) t1
           on t.cid=t1.cid
           group by 
